...
<!-- 本段是 anoni-net/docs 的增補，不是上游內容。上游：https://github.com/jgraph/drawio-mcp 的 plugins/claude-code/skills/drawio/SKILL.md（commit c094dff），Apache-2.0，全文見同目錄 LICENSE。上游更新時整份換掉再補回本段。 -->
