...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/travel-briefing-flow-v4.en.svg"
    ...
    <figcaption>The AI's answers are a starting list of what to look up. This works for any destination and complements the East and Southeast Asia article: that one gives a verified comparison of fourteen places, this one gives the method for checking anywhere else. Once you have the answers, run through the tiered checklist in the business travel article. The two together make a complete pre-departure routine.</figcaption>
</figure>
