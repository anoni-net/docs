---
title: Speaking online from Singapore and Malaysia
description: The Singapore–Malaysia online-speech environment (POFMA, FICA, CMA Section 233, sedition) and real-name identity layers, and how to reduce legal and identification exposure, for the Sinophone community and diaspora.
icon: material/comment-alert-outline
---

# :material-comment-alert-outline: Speaking online from Singapore and Malaysia
...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/sg-my-speech-laws-v4.en.svg"
...
Start from [how to build a threat model](../basics/threat-model.md): name who you are trying to stay out of view of (the state, an employer, family, a harasser) and what they can already see. Then, concretely:
...
- **Pick messaging for the metadata, not just encryption**: Which app ties to your phone number, and which does not, matters more here than the encryption alone. See [secure messaging compared](../tools/messaging-comparison.md).
- **Plan for device search at a border**: Cross-border travel is a common exposure point for the diaspora; prepare the device before you travel. See [cross-border travel and device searches in Asia](./asia-travel.md).
- **Route to the specific scenario**: If your situation is LGBTQ-specific, the [LGBTQ+](./lgbtq.md) scenario covers Singapore and Malaysia in detail; for source protection, see [journalists](./journalist.md).
...
- [LGBTQ+ across the Sinophone region](./lgbtq.md): the Singapore and Malaysia detail for LGBTQ-specific situations.
- [Secure messaging compared](../tools/messaging-comparison.md): choosing a channel by what it ties to your identity.

[^pofma]: Singapore brought its first criminal charge for communicating a false statement of fact under POFMA in March 2026, and its first charge for defying a correction direction in April 2026. See [Singapore: Drop All Criminal Charges Against Government Critic](https://www.hrw.org/news/2026/03/25/singapore-drop-all-criminal-charges-against-government-critic-and-repeal-repressive){target="_blank"} (Human Rights Watch, 25 March 2026) and [Singapore activist Kokila Annamalai charged under POFMA](https://theonlinecitizen.com/2026/04/23/singapore-activist-kokila-annamalai-charged-under-pofma-over-refusal-to-comply-with-correction-order){target="_blank"} (The Online Citizen, 23 April 2026).

[^cma]: The Communications and Multimedia (Amendment) Act 2025 came into force on 11 February 2025, changing "offensive" to "grossly offensive" in Section 233(1)(a) and raising the penalty to a fine up to RM500,000 or up to two years' imprisonment. See [Amendments to the Communications and Multimedia Act 1998 Come into Force on 11 February 2025](https://www.skrine.com/insights/alerts/february-2025/amendments-to-the-communications-and-multimedi-1){target="_blank"} (Skrine).

[^heidy]: In *Government of Malaysia v Heidy Quah Gaik Li* (Federal Court, 6 February 2026), the court upheld the constitutionality of the "offensive" and "annoy" wording but required proof of genuine intent, finding the prosecution of Quah's Facebook post unjustified. See the [Article 19 press summary](https://www.article19.org/wp-content/uploads/2026/02/GOVERNMENT-OF-MALAYSIA-v-HEIDY-QUAH-GAIK-LI_Press_Summary.pdf){target="_blank"}.

[^sedition]: For example, the activist Chegubard was charged in June 2026 over a social-media post concerning Negeri Sembilan royalty and fined in July 2026 over another. See [Malay Mail, 25 June 2026](https://www.malaymail.com/news/malaysia/2026/06/25/sedition-charge-for-chegubard-over-social-media-post-on-negeri-sembilan-royalty/225132){target="_blank"}.
