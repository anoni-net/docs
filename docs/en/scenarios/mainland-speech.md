...
# :material-broadcast: Posting on mainland Chinese platforms
...
It is a companion to [speaking online from Singapore and Malaysia](./singapore-malaysia-speech.md), which covers a different legal frame in the same region.
...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/speech-reach-risk-v2.en.svg"
...
- **[China Digital Times' 404 Archive](https://chinadigitaltimes.net/chinese/404-articles-archive){target="_blank"}** rescues and publishes deleted articles.
- **[CDT's open-source sensitive-words research project](https://chinadigitaltimes.net/chinese/sensitive-words-project){target="_blank"}** tracks censored terms across platforms over time, documenting the scale.
- **[GreatFire](https://greatfire.org/){target="_blank"}** monitors blocked sites and runs FreeWeibo (restoring deleted posts) and [FreeBrowser](https://freebrowser.org/){target="_blank"}. These services are themselves under continuous blocking and removal pressure.
- **[Citizen Lab](https://citizenlab.ca/){target="_blank"}** produces the empirical censorship research this page draws on.
...
[^image-filter]: [How WeChat Filters Images for One Billion Users](https://citizenlab.ca/2018/08/how-wechat-filters-images-for-one-billion-users/){target="_blank"} and [(Can't) Picture This 2](https://citizenlab.ca/2019/07/cant-picture-this-2-an-analysis-of-wechats-realtime-image-filtering-in-chats/){target="_blank"} — The Citizen Lab, on the OCR and visual-similarity algorithms and on filtering being invisible to the sender.
[^they-watch]: [We Chat, They Watch](https://citizenlab.ca/2020/05/we-chat-they-watch/){target="_blank"} — The Citizen Lab, May 2020.
