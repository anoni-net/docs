...
- [What surveillance can actually do](../basics/surveillance-capability.md) — the capability limits of the three adversaries above, plus telecom retention and commercial spyware
