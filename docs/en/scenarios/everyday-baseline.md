...
<figure markdown="span">
    <img src="https://assets.anoni.net/diagrams/baseline-layers.en.svg"
    ...
    <figcaption>Each layer answers one adversary, and the first removes the most loss</figcaption>
</figure>
