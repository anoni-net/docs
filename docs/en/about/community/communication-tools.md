...
description: How we use Matrix, Cryptpad, and Jitsi, and how to request accounts
icon: material/message-text
---

# :material-message-text: Communication and Collaboration Tools
...
- **Homeserver**: `im.anoni.net`
    ...
    - **Apps (Element X)**: [Download the apps](https://element.io/download) and set the homeserver to `im.anoni.net` after installation.
...
- **Recommended first step**: Join the community **[Public Space](https://matrix.to/#/#community:im.anoni.net)** to get entry points to the relevant rooms in one go.
...
- **Entry point**: Community Cryptpad [homepage](https://cryptpad.anoni.net/)
