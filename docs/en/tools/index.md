...
- [Encrypted DNS: what it changes, how to choose, how to verify](./encrypted-dns.md) — why typing `1.1.1.1` into Wi-Fi settings is not encrypted DNS at all, how DoH, DoT and DoQ differ under blocking, how to judge a resolver operator, and why a filtering resolver quietly corrupts your OONI measurements.
