...
- **[mashbean](https://pretalx.coscup.org/coscup-2026/speaker/ZMHFCQ/){target="_blank"}**: focused on decentralized tech and digital self-sovereignty; GM of Matters, former security-systems engineer at Taiwan's Ministry of Digital Affairs, now a Harvard policy visiting fellow and an Ethereum Foundation Silviculture member. Speaks on "I don't launder money — so why understand anonymous payments?".
