...
!!! info "Booth `6`, Sunday 6 September"
    ...
    - **On the table**: twelve browser-side tools you can try with your wifi switched off, three 3D interactives about Tor, and our anonymous payments research
...
Offline capability is the point, and it is also the proof. A tool that still runs with your wifi switched off cannot be sending your file anywhere, and you do not have to take our word for it. Switch the wifi off at the booth and use it. That check takes ten seconds and needs no ability to read code, although the source is in [anoni-net/docs](https://github.com/anoni-net/docs/tree/main/docs/zh-TW/js){target="_blank"} for anyone who wants to.
...
Alongside them are three 3D pieces about how Tor works: a [routing puzzle](../games/onion-routing.md), a [traffic flow view](../games/onion-rendezvous.md), and a [relay globe](../games/tor-network.md) built from real Onionoo data.

### Store them before you need them

Conference wifi is a poor moment to find out that a tool still needs downloading, and so is a shutdown. The [offline reading](../offline.md) page stores the pages you tick on your device, tools included, and afterwards the whole thing opens with the network off.
...
We read the programme and found no session on money. Donor anonymity, cross-border disbursement, sanctions and currency controls are daily work for a lot of organisations and appear in no session title.
...
We would especially like to talk to operators who have moved money across borders to high-risk or sanctioned regions, organisations that have handled donor anonymity, and projects that a bank or an exchange control has blocked.
...
The long version of why we came, which sessions overlap with our work and which booths we plan to visit is in [anoni.net at Global Gathering 2026](../blog/posts/2026-anoni-net-global-gathering.md). The zine on the table has [its own write-up](../blog/posts/2026-gg2026-printed-wrapper.md).
