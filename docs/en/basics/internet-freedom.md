...
Hong Kong's environment changed substantially after the 2020 National Security Law. Article 43 of the law lets police order ISPs to block websites through DNS tampering, a power already used against sites including HKChronicles and Hong Kong Watch. The 2024 Safeguarding National Security Ordinance, the long-pending Article 23 legislation, extended investigation and takedown powers further[^hk-snso]. Civic-space contraction, expansion of electronic identity (iAMSmart) and its integration with HKID, and a string of cases against journalists and platform users continue to shape the local picture[^4]. Macau follows a parallel-but-quieter trajectory.
...
[^hk-snso]: [Internet censorship in Hong Kong](https://hongkongfp.com/2024/10/12/internet-censorship-in-hong-kong/){target="_blank"} — Hong Kong Free Press, on Article 43 DNS-blocking orders against sites including HKChronicles and Hong Kong Watch. [Hong Kong: New Security Law a Full-Scale Assault on Rights](https://www.hrw.org/news/2024/03/19/hong-kong-new-security-law-full-scale-assault-on-rights){target="_blank"} — Human Rights Watch, on the 2024 Safeguarding National Security Ordinance.
