...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/monero-ring-v2.zh-TW.svg" alt="A Monero ring signature: the sender's real signature mixed among 15 decoys for a ring size of 16, where an observer can verify that one of the 16 is genuine without determining which">
</figure>
