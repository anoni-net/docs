...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/pq-timeline-v2.zh-TW.svg" alt="Post-quantum migration timeline: Signal PQXDH in 2023, NIST FIPS standards and browser rollout in 2024, major systems expected to complete migration between 2030 and 2035, hard deadline for legacy cryptography by 2040">
</figure>
