...
Officials have described the depth of the throttle twice. On 20 July, Defence Minister Wellington Koo [told the Legislative Yuan](https://www.ettoday.net/news/20260720/3204422.htm){target="_blank"} (Taiwan's parliament) that speeds would drop to one percent of 4G and 5G capacity. After the central Taiwan drill on 10 August, the Executive Yuan (Taiwan's cabinet) [described the method](https://www.cna.com.tw/news/aipl/202608100327.aspx){target="_blank"}: carriers apply rate limiting in the core network, capping mobile download speeds at 256KB. The two statements are of the same order, and either one gives a figure to expect when the measurements come in.
...
The rest is also mostly fixed line: StarVerse and DaDa Broadband each contribute tens of thousands, alongside campus networks at Fu Jen Catholic University, TANet (Taiwan Academic Network, the research and education backbone linking universities), and National Taiwan University.
