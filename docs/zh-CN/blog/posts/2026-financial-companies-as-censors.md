...
Reitman 在书里点出，这个模式之所以能长期运作，靠的是「金融机构是中性管道」这份既有认知。实际运作起来，合规导向的过度避险、模糊到不可预测的服务条款、自动化决策但没有人类审查介面、被切断的人没有可运作的申诉管道，这几个元素加在一起的效果跟内容被删除一样[^8]。EFF 过去十多年发过数十篇文章追踪这些案例，累积速度比修法快得多。
