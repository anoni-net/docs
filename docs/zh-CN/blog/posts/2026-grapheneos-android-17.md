...
至于 Pixel 本身，GrapheneOS 的说法是「不确定之后还会不会替新推出的 Pixel 加上支援」[^10]。媒体据此推测 Pixel 11 可能是最后一款受官方支援的新 Pixel，但这是媒体的推论，GrapheneOS 官方并没有做出这个承诺，它指的是 Pixel 11 之后的机型仍在未定之天。
