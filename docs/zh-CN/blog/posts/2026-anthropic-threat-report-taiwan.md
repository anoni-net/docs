...
| `GTG-10007` | 24 到 27 | 中国关联的间谍行动与自动化漏洞工厂 |
...
<p class="role-tags"><span class="role-tags__page">报告第 81 到 82 页</span><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--all">所有人</span><span class="role-tags__note">这一节是后面四个中国案例的共同背景，先读它再看个案比较容易定位。</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 89 到 92 页</span><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--faith">教会与宗教团体</span><span class="role-tag role-tag--civic">公民团体与倡议工作者</span><span class="role-tag role-tag--press">记者与研究者</span><span class="role-tags__note">台湾在这一节占五条工作线之一。</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 98 到 101 页</span><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--civic">公民团体与倡议工作者</span><span class="role-tag role-tag--press">记者与研究者</span><span class="role-tags__note">受访内容与公开发言怎么被处理成官方简报，写在这一节。</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 86 到 89 页</span><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--civic">公民团体与倡议工作者</span><span class="role-tag role-tag--press">记者与研究者</span><span class="role-tags__note">与流亡社群有协作的人尤其相关。</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 93 到 97 页</span><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--civic">公民团体与倡议工作者</span><span class="role-tag role-tag--press">记者与研究者</span><span class="role-tags__note">办公开活动的人请特别看场地情报那一段。</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 119 到 122 页</span><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--press">记者与研究者</span><span class="role-tags__note">主题是军事设施与模拟软件，只关心个人与组织安全的话可以跳过。</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 143 到 154 页</span><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--all">所有使用 AI 工具的人</span><span class="role-tag role-tag--dev">开发者</span><span class="role-tags__note">这一节与前面的监控案例可以分开读。</span></p>
...
??? question "有三个编号的写法与其他章节不一样"

    报告全文出现 39 个 `GTG` 编号，其中 36 个用连字号。只有 `GTG 16005`（第 147 页）、`GTG 16012` 与 `GTG 16003`（第 152 页）这三个改用空格，而且全部出现在本章的小标题里，其余章节的标题一律用连字号。那是报告排版上的疏漏，本文照原文抄录。用 PDF 搜索这三个编号时要记得改用空格，打连字号会找不到。

### 非法蒸馏的定义

蒸馏本身是正当的训练方法。研究者以一个较大、能力较强的「教师」模型对一组输入产生回应，再用产生的交换内容训练一个较小的「学生」模型去模仿教师。该做法常见的原因是它能降低取得进阶能力所需的资源。

Anthropic 对非法蒸馏的定义是：以工业规模、隐蔽地抽取一个模型的能力，并在未经授权的情况下复制到另一个模型。非法蒸馏通常靠欺诈达成，也就是用偷来的信用卡、登录凭证与 API 密钥建立的大量假账号网络。报告也提到其他前沿实验室同样面对同类攻击，OpenAI 自 2025 年初起持续指出该问题，Google 今年稍早发布过一份对抗性蒸馏的追踪报告。
...
<p class="role-tags"><span class="role-tags__page">报告第 148 到 149 页</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 149 到 150 页</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 147 到 148 页</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 150 到 153 页</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 146 到 147 页</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 153 到 154 页</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 12 到 30 页</span><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--dev">开发者</span><span class="role-tags__note">手上管着 API 密钥的人尤其相关。</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 24 到 27 页</span><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--press">记者与研究者</span><span class="role-tag role-tag--dev">开发者</span><span class="role-tags__note">报告没有把这一件归因到中国政府，证据强度与前面几件不同，引用前先读本节的第二段。</span></p>

`GTG-10007` 与前面三件的性质不同，那是一个持续运作的间谍行动。报告研判操作者以中文沟通、可能位在中国湖南省长沙，其中两人被辨识为湖南某大学信息与通信工程学院的大学生，一人先前在中国安全公司深信服（Sangfor）实习过，并正在应征另一家中国安全公司奇安信（QiAnXin）的攻击性网络作业职位。

归因的限度要先说明，报告用的措辞是「可能位在」，行动者的身份是学生与求职者，Anthropic 没有把这个行动归因到中国政府，也没有为它标示信心等级。前面长老教会与维稳那几件明写「与 PRC 政府立场一致」，两者在证据强度上属于不同层级，引用时要分开处理。

行动者以 Claude 当成整个攻击计划的工程与编排层，平行推进多条工作线，包含对正式系统的入侵尝试、对中东、欧洲与东南亚的外国政府网络做侦察、针对主流端点安全产品的漏洞研究与 exploit 开发、恶意软件开发，以及情报收集平台的建置与维运。

规模与结果：

- 目标约五十个组织，涵盖教育、零售、能源、科技、医疗、金融、制造，以及全球多个政府机关
- 入侵一家教育科技公司，从其云端存储取走数百 MB 的学生个人数据
- 取得一家零售公司的正式环境访问权，触及内部主机并展示修改线上环境的能力
- 针对东南亚某政府机关取走公民记录，包含姓名、电话与住址
- 对一款主流安全产品持续做漏洞研究，产出多个先前未知的漏洞并在自有实验环境验证，同一批研究也产出数个网络与安全设备家族的可用 exploit

第 26 页描述了自动化的程度。操作者例行执行 agent swarm，由一个主导的 AI 代理拆解侦察与后渗透工作，派发给多个平行执行的子代理。行动维持持续性的战役记忆，目标清单、收割到的凭证、接战状态与常设指令都跨 session 保存，每一次连上都能带着累积的上下文从中途接续。同一页另记录一条针对设备固件的零日研究循环，把固件载入反编译器、由代理走过反编译与交叉参照、形成漏洞假设、写出 exploit 代码、在实验室副本上测试并反复修改直到成功，成功的成果进入操作者的私人 exploit 库。其中一条针对网络设备的工作流，一个月内产出超过十个可能的零日发现。

对读者比较有用的两个观察是，用来检测入侵的安全产品本身就是被研究的对象，而行动的持续性由记忆文件与子代理承担，不再取决于操作者当下是否在线上。

## 影响力行动与商业监控里与倡议工作者相关的段落

<p class="role-tags"><span class="role-tags__page">报告第 41 到 85 页</span><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--civic">公民团体与倡议工作者</span><span class="role-tag role-tag--press">记者与研究者</span><span class="role-tags__note">手法与从事倡议、国际连结工作的人处境重叠。</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 43 页</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 78 页</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 70 页</span></p>
...
<p class="role-tags"><span class="role-tags__page">报告第 82 到 85 页</span></p>
...
网络行动章节第 5 页的第一个小标写着，高明的攻击不再需要高明的攻击者。Anthropic 的说法是 AI 抹平了资源充足的国家级行动与个别操作者之间的人力与工具落差，一年前需要多名熟练操作者与专业知识才撑得起的多受害者行动，现在单一行动者就能维持。同一章接着写，行动的精致程度已不再是判断幕后是谁的可靠信号，而公开可取得的攻击代理框架让任何人下载后都能复制同一套脚手架，自动化攻击链的每一个步骤。报告在该处举的例子是俄罗斯的情报行动 `GTG-20006`（第 6 页），该行动者以自动化提高作业速度。
...
<p class="role-tags"><span class="role-tags__label">适合读者</span><span class="role-tag role-tag--press">记者与研究者</span><span class="role-tag role-tag--civic">公民团体与倡议工作者</span><span class="role-tags__note">本节内容查核至 2026 年 9 月 13 日，之后的发展需要自行追踪。</span></p>

报告发布之后这几天的发展，与报告本身分开记录。以下每一项都标出日期与来源，方便判断哪些已经查证、哪些还没有。

| 日期 | 事件 |
|---|---|
| 9 月 8 日 | 美国 NSA、CISA 与 FBI 发布联合安全公告 `AA26-251A`，点名六家中国 AI 公司 |
| 9 月 9 日 | 中国商务部回应，称指控没有事实与法律依据 |
| 9 月 10 日 | Anthropic 发布这份报告 |
| 9 月 10 到 11 日 | 台湾媒体大量报导，焦点集中在电子战的 12 个目标 |
| 9 月 11 日 | 被点名的实验室对媒体询问未提出实质回应 |
| 9 月 12 日 | 中文社群流传月之暗面创始人与高管被带走，公司同日发声明否认并报案 |

### 美国政府的公告排在报告之前

NSA、CISA 与 FBI 在 2026 年 9 月 8 日发布联合安全公告 `AA26-251A`[^cisa]，点名六家中国 AI 公司对美国前沿模型进行工业规模的蒸馏，被锁定的模型涵盖 Claude 3.7 到 Opus 4.8、GPT-4 到 GPT-5.5、Gemini 2.5 各版本与 Grok。对中国政府涉入程度的措辞是「很可能在中国政府知情的情况下」。

两份名单值得并排比对。美国政府那份六家是 DeepSeek、Moonshot AI、Alibaba、MiniMax、StepFun 与 Z.AI。Anthropic 那份七家是阿里巴巴、月之暗面、深度求索、智谱（海外品牌 Z.AI）、小米、商汤与 MiniMax。两份的交集是五家，美国政府那份多了 StepFun，Anthropic 那份多了小米与商汤。引用时要写清楚出自哪一份，两者的证据基础也不同，一份是政府的情报判断，一份是单一厂商在自家平台上的观测。

### 中国官方的否认

中国商务部在 9 月 9 日回应美方公告，称指控没有事实与法律依据，并把蒸馏描述为 AI 产业的正常技术与商业问题，认为美方将其政治化。外交部要求美方停止无端指责与抹黑。中方同时警告，若以此为由对中国 AI 企业采取新的限制措施，将采取坚决反制。

这些回应针对的是美国政府 9 月 8 日的公告。Anthropic 的报告在 9 月 10 日才发布，截至本节查核时间，中国官方没有针对报告本身的个别案例提出说明。

### 被点名的实验室多半没有实质回应

TechCrunch 与 CNBC 在报导当下都做过询问。月之暗面拒绝置评，深度求索与小米没有在时限内回复[^press]。截至本节查核时间，七家之中没有任何一家对 Anthropic 的具体指控提出实质说明。

### 一则已被否认的传闻

9 月 12 日，中文社群流传一则说法，指月之暗面的创始人与十多名高管被带走调查。台湾有 YouTube 频道转述，媒体随后以「传」字下标报导[^ltn]。

月之暗面同日上午发出声明，称网传关于创始人及员工的信息纯属虚构、系恶意造谣，并表示已向公安机关报案，将依法追究造谣者的法律责任[^moonshot]。

三件事要分开看。这则传闻没有具名来源，也没有可查证的文件。公司的否认针对的是这则传闻，不是 Anthropic 的指控。至今没有第三方查证支持传闻的内容。本文把它记录下来，是因为它与报告在同一周流传，容易被读成报告的后续，而目前没有任何已知的关联把两者连起来。

本文不转述传闻中的个人姓名。在一则被当事公司指为虚构、并已报案的说法里，把特定个人与遭到拘留连在一起，对读者判断这件事没有帮助。

### 台湾那边的反应

台湾媒体在 9 月 10 到 11 日大量报导这份报告，焦点集中在电子战软件把模拟场景改成台湾 12 个目标那一段。长老教会领导层被建档与舆情简报把台湾媒体列为监控类目这两段，报导的篇幅明显少很多。

截至本节查核时间，没有查到台湾基督长老教会总会针对此事的公开回应，也没有查到政府机关针对报告中台湾相关段落提出正式说明。

## 这份报告的局限

- 报告由 Anthropic 自行发布，案例的归因与信心等级皆由其判定。部分案例在文中明写低信心或中等信心，引用时应一并载明
- 可见范围仅限经过 Claude 的一侧。其他模型上发生的同类活动不在涵盖范围内，未被记录不等于未曾发生
- 被点名的五家中国实验室（阿里巴巴、月之暗面、深度求索、智谱、小米）对媒体询问没有回应，中国外交部与商务部否认同类指控[^press]
- 收录的是 Anthropic 挑选出的显著案例，报告第 3 页已载明此点
- 报告同时是一份商业文件。多个段落在说明蒸馏行动时，顺带比较了自家模型与其他实验室模型的防护强度，读的时候可以把该层面一并纳入考量
...
- 封禁账号、强化安全机制与分享情报等处置，都是 Anthropic 自己的陈述，没有外部查证
...
[^cisa]: [China-Based Artificial Intelligence Companies Conducting Industrial-Scale Distillation Campaigns Against U.S. AI Companies](https://www.cisa.gov/news-events/cybersecurity-advisories/aa26-251a){target="_blank"} - CISA、NSA 与 FBI 联合安全公告 `AA26-251A`，2026 年 9 月 8 日。

[^ltn]: [偷用美 AI 致解放军资料被看光！传月之暗面创办人及 15 主管全被抓了](https://ec.ltn.com.tw/article/breakingnews/5571609){target="_blank"} - 自由财经，2026 年 9 月 12 日。标题的「传」字与内文的「网络疯传」是该报导对消息性质的标示。

[^moonshot]: [月之暗面：关于创始人及员工被传播的信息纯属虚构 系恶意造谣已报案](https://news.mydrivers.com/1/1150/1150650.htm){target="_blank"} - 快科技，2026 年 9 月 12 日。
