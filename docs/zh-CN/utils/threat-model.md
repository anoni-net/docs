...
有一种情况不提供存档：对手选了亲密关系、一国执法或国家级。他们碰得到你的设备，也可能要求你解锁，passkey 没有比屏幕锁更强。密码管理器另设主密码而且已经锁上时多一道，但别把安全押在这上面。「我要防的是亲密关系的人」这种答案留在对方碰得到的设备上，正好是最不该留的东西。那时只剩「复制摘要」，贴到对方碰不到的地方。
