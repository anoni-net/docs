...
相较有组织后援的媒体，独立工作者较常面对信息安全与法律支援上的落差，个人与线上协作的暴露面也较大。匿名网络有助于线上调查、与消息来源建立沟通管道，也在高压主题下降低连线与身份被锁定的可能。需要佐证特定网络环境是否出现封锁或降速时，可查 OONI 公开数据。需要把整个工作环境与流量默认导向 Tor、且关机后尽量不留本机痕迹时，也会使用 Tails 这类做法。
