---
title: 什么是匿名网络？
description: 匿名网络让使用者不必默认交出身份与行为轨迹，仍能连线、取得资讯、参与协作。在本项目中，它是一组以开放工具为基础的网络使用实践，也是台湾社区在 2026 年持续推动的核心方向。
icon: material/chat-question
---

# :material-chat-question: 什么是匿名网络？

**匿名网络**让使用者在连上互联网时，不必默认交出自己的身份或留下完整的行为轨迹，仍能自由地取得资讯、沟通与协作。它涵盖的范围相当广，从连线方式、使用环境，到让网络干预得以被观测与记录，都属于这个概念的一部分。
...
相较有组织后援的媒体，独立工作者较常面对信息安全与法律支持上的落差，个人与线上协作的暴露面也较大。匿名网络有助于线上调查、与消息来源建立沟通管道，也在高压主题下降低连线与身份被锁定的可能。需要佐证特定网络环境是否出现封锁或降速时，可查 OONI 公开数据。需要把整个工作环境与流量默认导向 Tor、且关机后尽量不留本机痕迹时，也会使用 Tails 这类做法。
...
<figure markdown="span">
    <img src="https://assets.anoni.net/diagrams/tool-layers.zh-CN.svg"
        alt="四个工具层的结构关系。连线层的 Tor 工具家族是核心，环境层的匿名操作系统把整个连线层包在里面。观测层独立在旁边，记录连线遇到了什么，本身不保护连线。日常隐私基本功横跨在最底下，不管上面用哪一层都要。">
    <figcaption>四层之间，哪一层包住哪一层</figcaption>
</figure>

上面四张卡片是四个家族各自在做什么，它们之间还有关系。环境层把连线层整个包在里面，所以装了 Tails 等于同时有了连线层。观测层独立在旁边，它记录连线遇到了什么，本身不保护连线。日常基本功横跨在最底下，不管上面用哪一层都要。
