...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/vpn-trust-shift-v4.zh-CN.svg"
...
上面那段提到的信任分配，画出来是这个形状。橙色那一格是同时知道你是谁与你连哪的节点。直接连的时候是 ISP，开了 VPN 之后换成 VPN 业者，单点的数量没有变，换掉的是那家公司是谁。Tor 那一行没有橙色，因为那两件事被拆给三个互不相干的中继。
