...
知道自己属于哪一类，[从你的身分开始](./start/index.md)有依身分整理的阅读路径。想直接挑主题，从下面四张卡开始。
...
## :material-wifi-off: 没有网络也能读

整个文档站可以存进手机或电脑。用一般浏览器打开过并选一次阅读语言，核心章节就会在后台存进设备，断网时照样能打开。要把整站带着走、挑选要留哪些页面，或装成有自己图标的 App，照[离线阅读](./offline.md)的三个步骤做，最后用飞行模式确认一次。Tor Browser 与 onion、IPFS 版基于隐私考量不提供这项功能。

[:material-wifi-off: 离线阅读](./offline.md){ .md-button .md-button--primary }
