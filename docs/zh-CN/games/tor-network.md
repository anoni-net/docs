...
海面上较细的线条是海底电缆，取自 OpenStreetMap 贡献者标注的两百余段路径，收录以欧洲、地中海与大西洋较为完整。最淡的一层是主要跨洋走廊的示意，取两端公开的登陆地点拉出大圆弧，仅走向可信，实际路由请参考专门的海缆地图。国界与海岸线来自 Natural Earth 的 50m 比例尺。亚洲那一带简化时留到约 1 公里，其余约 18 公里，因为站上的读者多半在亚洲。更粗的 110m 没有收录新加坡、香港与澳门，岛链的形状也只是几个点连成的折线。
