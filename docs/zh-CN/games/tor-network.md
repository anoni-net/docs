...
开场载起来的是地球本身、海底地形、Tor 中继与连线受阻，另外十一层摆在左侧面板最上方那一排格子里。按一下才去抓那一份数据并画上去，再按一下收回去，没按过的层完全不占流量。

十四份数据压缩后合计 800 KB，开场那四层占 429 KB，也就是进来先付一半多一点。其余十一层里最重的两块是海岸线 237 KB 与台湾那五层 95 KB。海岸线只是把海陆交界描得更锐利，没有它的时候国界与陆地填色照样分得出海陆，所以它排在按需那一边。
...
### 东亚与东南亚的行政区界线（DATA.GOV.HK、Natural Earth public domain）

贴近日本、韩国、香港或东南亚各国时，陆地上会淡入一层细线，例如日本的都道府县、韩国的道与广域市、香港的 18 区，以及越南、泰国、菲律宾、印尼等十一国的省与州，跟贴近台湾时出现县市界是同一件事。每一国的界线是一份独立的小文件，镜头贴近那一国才去抓，一个典型的行政区在屏幕上够大了才画出来，所以日本的县比香港的区早出现。只画相邻两区共用的那条边，外框交给国界与海岸线，有主权争议的孤立岛屿因此不会被画进任何一国。香港的区界来自[香港特别行政区政府民政事务总署](https://data.gov.hk/sc-data/dataset/hk-had-json1-hong-kong-administrative-boundaries)，经 DATA.GOV.HK 发布，依[使用条款](https://data.gov.hk/sc/terms-and-conditions)使用。原数据把海面也分给各区，这里只留陆地上的部分。其余各国暂时没有容易取得的官方数据，用的是 Natural Earth 的一级行政区，这份数据放大之后比官方的粗，香港那一份就差了三十倍，而且不是每一国都跟上现况：印尼 2022 年巴布亚拆出新省，这里仍是旧的 33 省。
