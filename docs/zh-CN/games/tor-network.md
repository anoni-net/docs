...
海面上较细的线条是海底电缆，取自 OpenStreetMap 贡献者标注的两百余段路径，收录以欧洲、地中海与大西洋较为完整。最淡的一层是主要跨洋走廊的示意，取两端公开的登陆地点拉出大圆弧，仅走向可信，实际路由请参考专门的海缆地图。国界与海岸线来自 Natural Earth 的 10m 比例尺。东亚那一块的海岸线简化时留到约 220 公尺，相邻两点相距 2.2 公里，其余亚洲与世界其他地方逐级放粗，因为站上的读者多半在东亚。更粗的比例尺下，日本与菲律宾的岛链只是几个点连成的折线，放大之后看起来是一段一段的方块。
