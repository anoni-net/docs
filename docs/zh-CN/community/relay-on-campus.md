---
title: Tor Relay 校园建立研究专题
description: 2026 三大主题之一：与 EFF/Tor Project 推动校园 Tor 中继节点的计划、案例与如何加入。
...
- **带宽稳定**：学术网络通常有充足且稳定的带宽
- **技术人才在场**：资工、资管、资讯中心的师生有架设与维运能力
- **法律与制度相对清晰**：学校有正式的提案与审核流程，比个人或小公司架设更容易说明用途、争取支持
...
- **观测即时化**：透过 [Pulse](https://anoni.net/api/readme){target="_blank"} 持续追踪校园节点的运作状况
...
- **Tor Project blog 客座文章**：把台师大案例写成英文版本，刊登于 [Tor Project blog](https://blog.torproject.org/setting-up-tor-university-relay-taiwan/){target="_blank"}，登录到全球视野
- **Tor University Challenge 中译**：完成 [EFF Tor University Challenge 网站](https://toruniversity.eff.org/zh-tw/){target="_blank"} 的正体中文翻译，降低台湾其他学校接触计划的语言门槛
- **观测站 Pulse 上线**：[Tor Relays 观测点](../taiwan/tor-relay-watcher.md) 即时显示台湾（与日本、南韩、香港）的中继节点状况
- **访谈企划**：把台师大架设过程整理成 [深度访谈](../blog/posts/ntnu-nz.md)，公开给后续推动者参考
...
- **大学在学、校友、教职员**：对自家学校有理解，能评估推动可行性
- **网络维运经验**：能参与技术设置与长期维运
- **政策沟通能力**：能协助跟校方、资讯中心、法务单位沟通
- **法律专业**：能解读中继营运相关的法律疑虑（个资、刑事、学校规章）
- **活动筹办经验**：能把架设工作整合进信息安全周、迎新等校园活动

不需要架过 Tor Relay 也欢迎参与。「我想学」就是合理的加入动机，社群会搭配 [如何搭建 Tor Relay](./setup-tor-relay.md) 文件协助你实际操作。

## 议题守则

社群所有讨论以合法用途为前提。Tor Relay 校园主题会以教育、研究、基础建设参与为目的呈现，不协助任何违法行为。校园架设过程涉及学校资源使用，应走正式提案与审核流程，并充分告知校方节点用途与营运责任。
