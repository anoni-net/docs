...
社群协作久了会累积许多不成文规定：标题该怎么下、文件名怎么命名、PR 描述要写什么、Issue 怎么分类、新贡献者第一周会碰到的疑问。这份贡献者百科把这些散落在 README、Issue 留言、Matrix 对话里的内容整合成一页，方便新成员一次看完，也让资深成员有共同对话的依据。
...
| 问题 | 看这里 |
|---|---|
| 怎么选一个主题开始？ | [如何参与与认领主题](./how-to-contribute.md) |
| 怎么申请 Matrix 账号？ | [社群自架服务](./tools.md) |
| 我的程度适合做什么？ | [自我技能评估表](./skill-level.md) |
| 怎么设好开发环境？ | [项目研究预先准备](./setup-repo.md) |
...
社群以开放、互助、合法为原则。完整的治理章程见 [治理章程](./governance.md)（撰写中）。重点：
