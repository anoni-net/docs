...
!!! warning "草案征求共识中"
    ...
    这份治理章程还在草案阶段，尚未正式取得社区伙伴的共识，条文随时可能调整。在正式通过前，社区以这份草案作为实际运作的参照，遇到争议依此处理。欢迎一起讨论社区的未来，可在 Matrix 公开 room 或 GitHub Issue 提出想法，具体修订流程见下方 [章程修订](#章程修订)。
