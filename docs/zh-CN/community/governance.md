...
3. **严重事件**（骚扰、跟踪、人身威胁）：核心成员会立即移除违规成员的访问权限，事后在公开 room 简述处置（不揭露受害者身份），并依需要协助受害者报警或联系援助资源
...
- 涉及个人数据、未公开研究、敏感受害者身份的内容，走 [上传机敏信息流程](./upload-sensitive.md)
...
3. **暂时隔离**：暂停 Matrix 账号、Cryptpad 访问、GitHub 权限数天到数周
