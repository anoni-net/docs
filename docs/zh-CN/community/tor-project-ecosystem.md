...
4. 运营中继或架网桥。有机器与带宽的成员可架设中继，强化区域节点覆盖，技术操作见 [如何搭建 Tor Relay](./setup-tor-relay.md)。想架设伪装成 HTTPS 的网桥见 [设置 Tor WebTunnel](./setup-tor-webtunnel.md)，求助渠道是 `#tor-relays` 与 tor-relays 邮件列表。
