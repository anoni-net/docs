...
关于 Tor 网络本身的设计与威胁，见 [什么是 Tor](../tools/what-is-tor.md)。InterSecLab 对中国防火长城资料外泄的分析（[网络政变报告](https://anoni.net/docs/zh-tw/reports/interseclab-network-coup/){target="_blank"}）也说明了「集中化的审查基础建设」如何成为去中心化策略的对手。
