...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/pq-timeline-v2.zh-TW.svg" alt="后量子密码迁移时程：从 2023 Signal PQXDH、2024 NIST FIPS 与主流浏览器启用、到 2030–2035 主要系统应完成转换、2040 旧密码学硬时间表">
</figure>
