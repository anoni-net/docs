...
多数说自己在用 IPFS 的人没有架设节点，只是开公开网关的网址来读。这个情境的暴露面是另外一组，DHT 上看不到你，网关业者则是一次看到你的 IP 与你要的每一个 CID，你在网络上的样子就是一个普通的 HTTPS 客户端，去中心化的那一部分换回了单一业者。
...
??? question "我只用公开网关读 IPFS，暴露面一样吗"
    ...
    不一样，但也没有比较好。开公开网关的网址时你没有加入 DHT，所以 DHT 上看不到你，代价是网关业者一次看到你的 IP 与你要的每一个 CID。自行架设节点是把信息公开给网络上的许多人，用网关是把信息集中交给一家业者。
