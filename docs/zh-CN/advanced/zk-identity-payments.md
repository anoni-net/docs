...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/monero-ring-v2.zh-TW.svg" alt="Monero Ring Signature 示意：寄件人的真实签章混进 15 个诱饵中，环大小 16，观察者只能验证「16 个之一是真的」、无法反推哪一个">
</figure>
...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/zcash-shielded-v2.zh-TW.svg" alt="Zcash 屏蔽交易：寄件人与收件人之间透过 zk-SNARK 证明连线。链上可见的部分：proof、nullifier、commitment、手续费。链上不可见的部分：寄件人地址、收件人地址、金额、图谱关联">
</figure>
