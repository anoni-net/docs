...
- **强制关联到真实身份**：银行账户、信用卡、电子支付的开户都需要实名与身份证明，这是法律要求的 KYC（Know Your Customer）
...
前面提到的是金流的被动观察风险，metadata 被别人看到、被分析、被关联回真实身份。金流还有另一面是被主动拿来当审查工具。
...
回到没有电子支付的时代，现金的匿名性很完整：

- 不绑实名（路边买瓶水不需要出示证件）
- 不留下与身份对应的数字记录（除非摄影机、信用卡同步交易等外围因素）
- 不可被远端冻结或撤回
- 全球普遍接受（在多数国家通用）
