...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/fingerprint-funnel-v4.zh-CN.svg"
        alt="一个由上往下收窄的漏斗，分成六阶。最上面一阶最宽，代表所有浏览器。往下每一阶加入一项浏览器指纹的特征，人群就缩小一次：加上时区之后剩下同一个时区的人，加上语言与操作系统之后还是很多人，加上屏幕与窗口尺寸之后范围明显缩小，加上绘图硬件之后剩下不多，加上完整的字体清单之后常常就只剩你一个。每一阶的宽度是示意，不是测量到的数字。底下注记 EFF 在 2010 年的 Panopticlick 研究收集了 470,161 个浏览器样本，其中 83.6% 的指纹是唯一的。">
    <figcaption>每加一项特征，还跟你长得一样的人就少一批</figcaption>
</figure>

上面那张图就是熵的形状。时区把你留在数以亿计的人群里，字体清单常常一步就把范围缩到个位数。没有任何一项特征单独认得出你，凑在一起就可以。
