...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/fingerprint-funnel-v2.zh-CN.svg"
        alt="由上往下收窄的六阶漏斗。最上面一阶是所有人，往下每一阶加入一项浏览器指纹的特征，人群就缩小一次。加上时区之后剩下同一个时区的人，加上语言与操作系统之后还是很多人，加上屏幕与窗口尺寸之后范围明显缩小，加上绘图硬件之后剩下不多，加上完整的字体清单之后常常就只剩你一个。每一阶的宽度是示意，不是测量到的数字。">
