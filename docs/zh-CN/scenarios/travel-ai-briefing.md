...
!!! warning "AI 会编造电话、法条与资费"
    语言模型很会「说得很有把握其实是错的」。把 AI 的回答当成「我接下来该查哪些东西」的起点，不要当成最终答案。尤其是紧急电话、法条编号、签证规则与资费，**一定**回到官方一手来源核对。要注意一个反差：目的地越冷门、公开资料越少，AI 手上的训练资料也越少、越容易乱编，偏偏这种地方最需要可靠信息。这种时候更要把 AI 的回答只当成「该查哪些东西」的清单，逐项拿去比对本页底部的一手来源。
...
- [出差与研讨会的数字准备（东亚与东南亚）](./asia-travel.md)：十四地已预填好审查、VPN、SIM 与入境查机，只去东亚东南亚、或赶时间不想自己跑 prompt 时，直接查那篇更快。
