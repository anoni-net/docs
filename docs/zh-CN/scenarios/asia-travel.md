...
通用准备里的「带最简化的装置」这一条，展开来就是要不要另外准备一台机器。这节处理三个常见问题：有没有必要、能不能在外地买、带回来之后会发生什么。

### 先把「装置」与「号码」分开

burner 这个俗称把两件事混在一起，它们的风险来源不同：
...
「在外地买一张没人知道是我的卡」在这个区域几乎做不到。上面对照表的「SIM 实名」栏就是答案，十四地里只有柬埔寨没有强制实名的法规，而当地电信商办卡多半仍要求出示证件。

- 落地办实名卡等于把护照送进当地电信商与政府的数据库
- 中国大陆与泰国另外要求人脸，泰国自 2025 年 8 月起导入脸部活体侦测
- 旅客卡多半有效期短，新加坡 30 天、泰国 60 天

要降低「当地政府能不能当场把号码对应到你」这个风险，有效的做法是把对应留在境外，也就是通用准备里的漫游或纯数据 eSIM。境外购买本身不提供匿名。

### 带回境内会发生什么

把境外买的机器或号码带回自己所在地，有几件事会改变：

- **境外号码在境内漫游**：你的位置持续回报给境外电信商，境内单位要对应到你通常得走跨境调取。代价是一个外国漫游号码长期在你住处附近活动，这个模式本身就是特征
- **预付卡有效期**：旅客卡多为 30 到 60 天，带回来很快就失效，之后要靠境内充值或换卡
- **换插境内 SIM**：这台机器就跟你的境内身份绑在一起了，干净机的意义同时消失
- **IMEI 会把两个号码串起来**：同一台机器先用境外卡、回来再用境内卡，电信商侧看到的是同一个 IMEI 底下换过两个号码
- **海关**：携带多支手机在多数地区不违法，但会增加被询问的机会。工作机与私人机这种有实际用途的说明，比刻意藏起来合理

### 比较实际的做法

- 装置留着重复使用，每趟出发前重设，回来后不要拿它处理日常事务
- 不要在同一台机器上混用境外与境内号码
- 境内真的需要另一个号码时，在境内取得。实名这一层在境内同样避不掉，各地的登记要求见下方逐地注记
