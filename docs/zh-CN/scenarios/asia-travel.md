...
「在外地买一张没人知道是我的卡」在东亚与东南亚几乎做不到。上面对照表的「SIM 实名」栏就是答案，十四地里只有柬埔寨没有强制实名的法规，而当地电信商办卡多半仍要求出示证件。

- 落地办实名卡等于把护照送进当地电信商与政府的数据库
- 中国大陆与泰国另外要求人脸，泰国自 2025 年 8 月起导入脸部活体侦测
- 旅客卡多半有效期短，新加坡 30 天、泰国 60 天

要降低当地政府当场把号码对应到你的风险，有效的做法是把对应留在境外，也就是通用准备里的漫游或纯数据 eSIM。境外购买本身不提供匿名。

### 带回境内会发生什么

把境外买的机器或号码带回自己所在地，有几件事会改变：

- **境外号码在境内漫游**：你的位置持续回报给境外电信商，境内单位要对应到你通常得走跨境调取。代价是一个外国漫游号码长期在你住处附近活动，模式本身就是特征
- **预付卡有效期**：旅客卡多为 30 到 60 天，带回来很快就失效，之后要靠境内充值或换卡
- **换插境内 SIM**：机器就跟你的境内身份绑在一起，干净机的意义同时消失
- **IMEI 会把两个号码串起来**：同一台机器先用境外卡、回来再用境内卡，电信商侧看到的是同一个 IMEI 底下换过两个号码
- **海关**：携带多支手机在多数地区不违法，但会增加被询问的机会。工作机与私人机的区分有实际用途，比刻意藏起来合理
