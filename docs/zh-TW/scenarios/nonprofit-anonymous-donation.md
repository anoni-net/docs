...
公民團體與倡議組織常常需要兩件看似衝突的事：一邊保護支持者、捐款人不被識別，一邊維持對外的財務透明與合規。這兩件事可以並存。一份可運作的匿名捐款設計，會讓組織能對主管機關交代金流、對社群交代收支總量，同時讓個別捐款人可以選擇不被列名。

這篇文章從兩個角色切入。組織方如何建立可選的匿名收款管道（現金、加密貨幣、預付卡的取捨與內部風險管理），捐款人如何選擇合適的工具與通道（避免讓自己暴露身分）。中間穿插 Tornado Cash 制裁案例的提醒，最後是台灣的法規脈絡（公益勸募條例、政治獻金法、洗錢防制、稅務）。

要先理解為什麼要做到這個程度，可以回頭看 [為什麼匿名支付重要](../basics/payments-anonymity.md) 與 [威脅模型如何建立](../basics/threat-model.md)。工具細節對應到 [加密貨幣的隱私光譜](../tools/crypto-privacy-spectrum.md)，台灣法規對應到 [台灣 VASP 法 2026](../taiwan/vasp-2026.md)。

!!! warning "香港與跨境捐款讀者請先讀"

    本頁的法規脈絡是台灣的（公益勸募條例、政治獻金法、VASP）。香港的風險層級不同，也高得多。在「612 人道支援基金」案裡，為 2019 年反送中運動被捕者提供人道援助的眾籌基金遭調查停運，五名信託人一度以《國安法》第 29 條「勾結外國勢力」被捕，最終改以《社團條例》未註冊定罪。對香港的組織與捐款人，核心風險是資金用途本身可能被定性為危害國家安全，匿名捐款技術做得再乾淨也擋不掉這一層。想支持香港公民社會或流亡港人組織的跨境捐款人，同樣要留意香港《國安法》可能的域外效力。操作前務必按自身所在地重做威脅模型評估。
...
「捐款不就是給個帳號然後填收據嗎」是最常見的反應。對中性議題（救災、教育、寵物醫療）來說大致如此，但下面幾個情境就完全不是：
...
- **支付服務商可能單方面切斷收款管道**：PayPal、Stripe、Patreon 多次以模糊規則關閉倡議組織與創作者帳號，台灣還多一層結構性排除（PayPal 2017 關閉境內交易功能、Stripe 至今未開放台灣使用者註冊）。組織除了考慮匿名收款，也要為主要管道被切斷準備備援。詳見 [金融公司也能當審查者](../blog/posts/2026-financial-companies-as-censors.md)

換個角度說，捐款人的識別資訊跟政治立場、性向、家庭結構、社群關係綁在一起，這份資訊比一般消費紀錄敏感得多。組織方願意提供「可選的匿名通道」，本身就是對支持者基本的尊重。

<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/donation-channels-v4.zh-TW.svg"
        alt="上半部是組織方三種收款管道的對照。現金的匿名度高、合規負擔中、規模化低、不能跨境，適合活動現場與公開信箱的小額支持。加密貨幣的匿名度中至高、合規負擔高、規模化高、可以跨境，適合跨境捐款與需要規模的情境。預付禮物卡與超商代碼的匿名度中、合規負擔低、規模化中、限境內，適合門檻最低的境內小額。下半部是捐款人視角的四種威脅與對應通道。想躲家人或雇主看到金流的人走現金、預付卡或隱私幣，避開信用卡與共用銀行帳戶。想躲組織方留下身分紀錄的人走不留 email 的現金捐贈或隱私幣到自管錢包，避開銀行匯款因為戶名會留。想躲跨境監控的人走 Monero 或 Zcash 遮蔽交易，避開比特幣到中心化交易所。純粹個人偏好不留紀錄的人用任意現金管道即可，避開任何電子支付。">
    <figcaption>組織方準備兩條路，捐款人依自己要躲的對象選一條</figcaption>
</figure>

## 組織方：建立可選的匿名收款管道

「可選的匿名」這四個字是設計的核心，讓想匿名的人有路可走，同時想列名的人也能正常列名，兩條路並存。實務上多數捐款人會走列名管道（為了取得收據、為了加入會員），少數人會走匿名管道（為了上述各種敏感原因）。組織方準備好兩條路，比強迫所有人走同一條更尊重支持者的處境。
...
加密貨幣是匿名捐款裡技術門檻最高的選項，但也是跨境與規模化做得最徹底的選項。沒有跨境收款或規模化需求的國內小型組織，可以略過這幾節，直接看下面的 [現金與預付卡的搭配](#組織方現金與預付卡的搭配)，多數團體用那一組就夠。下面以一個有跨境需求的小型倡議組織做為範例。

### 自管錢包與託管平台的選擇

兩種主要架構：

- **自管錢包（self-custody）**：組織自己持有私鑰，常見實作是 Bitcoin Core、Electrum、Sparrow（BTC），MetaMask、Frame、Rabby（ETH 與穩定幣），Cake Wallet、Feather（Monero）。優點是不依賴第三方、不需要 KYC（金融服務要求的身分驗證程序，會留下捐款人身分），缺點是私鑰管理是組織責任，遺失即失去資金
- **託管平台（custodial）**：透過合規交易所（CEX）開機構戶接收捐款，再轉自管。優點是有客服與保險，缺點是接收即被 KYC、捐款人資訊可能被交易所留存

實務建議是「以自管為主、託管為輔」。日常小額走自管錢包，大額或需要快速換匯走機構戶。

多重簽署（multisig）是這個段落的關鍵字。2-of-3 設計把私鑰分給三個角色（例如執行長、會計、外部理事），任何單一人遺失或離開都不會讓資金鎖死，也避免單一人挪用。Bitcoin 用 PSBT、Ethereum 用 Safe（前身 Gnosis Safe）是最普遍的兩種實作。

### 顯示「收款地址」的網頁設計

組織官網上要如何把捐款地址公開出來，本身是一個會被忽略的設計題：
...
- **入帳時點與市值認定**：依一般會計處理，收受加密貨幣的入帳時點是「實際取得」當下的台幣公允市值。這需要保留交易截圖、區塊鏈瀏覽器連結、當時的匯率來源
...
- **公開信箱、活動現場匿名箱**：擺一個物理上的捐款箱，活動結束後由兩人以上開箱、現場點數、立刻入帳。現場匿名箱在勸募條例下可能落入「不特定人勸募」的範疇，要確認是否需要事前申請（見後面的台灣脈絡章節）
- **超商繳費代碼**：透過第三方支付服務商（綠界、藍新、ECPay）開放繳費代碼，捐款人到超商付現繳費，組織端只看到代碼沒有姓名。限制是平台層面仍可能有紀錄、單筆金額有上限（多數平台是 2 萬元）
- **預付禮物卡的匿名捐贈**：跨境支持境外組織時，預付禮物卡（如 Apple Gift Card、Steam Wallet）有時是少數可行選項。捐款人現金購卡，把序號透過加密通道（Signal、OnionShare）傳給對方。但預付卡有強烈的詐騙連結，組織方公告時要特別說明使用情境
...
- **以為「匿名」等於「沒留紀錄」**：組織方的對外財報、內部對帳、區塊鏈本身的公開可查，三者都會留下紀錄。匿名只做到不識別個別捐款人是誰，這筆錢在財報、對帳、鏈上都還是存在的
- **跨境捐款沒有考慮到對方收款限制**：把錢送到境外組織前，要確認對方在當地的法規環境下能不能合法接收。台灣很自由不代表對方所在地也一樣

這些錯誤共通的根源是「先把技術做出來，再來想政策與流程」。順序倒過來會更穩：先想清楚要服務誰、要面對哪些主管機關、內部如何分權，再決定要不要、用哪一種技術做出可選的匿名管道。
...
2. 對方能取得什麼資料？銀行流水、社交媒體、共用裝置、共用網路？
...
先說清楚：境內小額支持，用現金、超商代碼或預付卡最簡便，不必走到加密貨幣。下面這套隱私幣流程是給「跨境支持境外組織、又想把匿名做到最高」的情境，門檻明顯高一截。
...
整個流程裡，最容易被忽略的環節是「取得隱私幣」這一步。多數捐款人走到第一步就發現門檻太高而放棄，也說明為什麼預付卡、現金等低門檻通道不能被加密貨幣完全取代。

## 警示：Tornado Cash 制裁案例

加密貨幣匿名工具的法律風險，過去幾年最重要的指標案例是 Tornado Cash。對倡議組織來說這個案子是判斷「我做的事情有沒有越界」的具體參考，不能當技術八卦看。
...
- **2025 年 8 月**：Roman Storm 案在紐約南區地方法院宣判，陪審團就「共謀經營無照匯款業務」一項判決有罪，另兩項較重罪名（共謀洗錢、共謀違反制裁）陷入僵局未決，後續程序仍在進行

### 對倡議組織的三個提醒

從這個案例可以拉出三條判準，組織方在設計加密貨幣捐款管道前要對照思考：

- **「混幣器」與「隱私幣」是兩個不同的法律光譜**。Tornado Cash 是事後混淆來源（mixer），Monero 是協議層預設隱私（privacy by design）。前者更容易被認定為「協助掩飾資金來源」，後者目前在多數司法管轄裡更接近「使用一種具備隱私特性的工具」。但這條界線來自判例與行政實踐累積的判斷，沒有法律明文
...
- **合法**：該揭露的對主管機關揭露。AML（洗錢防制）、稅務、勸募條例、政治獻金法都有對應的申報義務，不要為了匿名而違反法定義務
- **可稽核**：對社群與捐款人的對外透明報告。年度收支總量公開、用途分類清楚，不揭露個別捐款人。透明報告做得越好，匿名管道的正當性越穩
- **保護弱勢**：個別捐款人不被識別，是匿名管道存在的目的，所有設計選擇都要回到這一點

這三者並非互斥的取捨。一個良好設計的匿名捐款管道可以同時滿足，反之，缺一個都會讓另外兩個的價值打折。
...
主管機關是衛福部（中央層級）與各直轄市、縣（市）政府（地方層級，承辦單位多為社會局或社會處）。適用對象是「公立學校、行政法人、公益性社團法人及財團法人」，以及經主管機關同意之公益團體。
...
- **匿名捐贈的法定上限**：依政治獻金法第 14 條，匿名捐贈的單筆上限為新台幣一萬元。第 15 條規定收受匿名政治獻金的總額，不得超過該次申報政治獻金收入總額的百分之三十，超過部分繳交受理申報機關辦理繳庫
- **不得收受的對象**：外國人、外國團體、大陸地區人民與團體、香港或澳門居民與團體、公營事業、有累積虧損尚未依規定彌補之營利事業，這幾類都不得收受。組織端在處理跨境加密貨幣捐款時要特別留意
...
- **加密貨幣的入帳與課稅時點**：會計上組織收受加密貨幣多以「實際取得」當下的台幣公允市值入帳。實際課稅通常發生在換成法幣（變現）時，依財產交易所得處理。兩個時點都建議保留交易截圖、區塊鏈瀏覽器連結、當時的匯率來源（CoinGecko、CoinMarketCap 截圖即可）
...
- **公益勸募條例疑義**：[衛生福利部社會救助及社工司](https://dep.mohw.gov.tw/dosaasw/){target="_blank"}（中央層級），各直轄市、縣（市）政府社會局或社會處（地方層級）
