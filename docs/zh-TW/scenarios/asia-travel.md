...
通用準備裡的「帶最簡化的裝置」這一條，展開來就是要不要另外準備一台機器。這節處理三個常見問題：有沒有必要、能不能在外地買、帶回來之後會發生什麼。

### 先把「裝置」與「門號」分開

burner 這個俗稱把兩件事混在一起，它們的風險來源不同：
...
「在外地買一張沒人知道是我的卡」在這個區域幾乎做不到。上面對照表的「SIM 實名」欄就是答案，十四地裡只有柬埔寨沒有強制實名的法規，而當地電信商辦卡多半仍要求出示證件。

- 落地辦實名卡等於把護照送進當地電信商與政府的資料庫
- 中國大陸與泰國另外要求人臉，泰國自 2025 年 8 月起導入臉部活體偵測
- 旅客卡多半有效期短，新加坡 30 天、泰國 60 天

要降低「當地政府能不能當場把門號對應到你」這個風險，有效的做法是把對應留在境外，也就是通用準備裡的漫遊或純數據 eSIM。境外購買本身不提供匿名。

### 帶回境內會發生什麼

把境外買的機器或門號帶回自己所在地，有幾件事會改變：

- **境外門號在境內漫遊**：你的位置持續回報給境外電信商，境內單位要對應到你通常得走跨境調取。代價是一個外國漫遊號碼長期在你住處附近活動，這個模式本身就是特徵
- **預付卡效期**：旅客卡多為 30 到 60 天，帶回來很快就失效，之後要靠境內加值或換卡
- **換插境內 SIM**：這台機器就跟你的境內身分綁在一起了，乾淨機的意義同時消失
- **IMEI 會把兩個門號串起來**：同一台機器先用境外卡、回來再用境內卡，電信商側看到的是同一個 IMEI 底下換過兩個號碼
- **海關**：攜帶多支手機在多數地區不違法，但會增加被詢問的機會。工作機與私人機這種有實際用途的說明，比刻意藏起來合理
