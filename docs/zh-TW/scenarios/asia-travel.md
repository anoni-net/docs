...
- **境外門號在境內漫遊**：你的位置持續回報給境外電信商，境內單位要對應到你通常得走跨境調取。代價是一個外國漫遊號碼長期在你住處附近活動，模式本身就是特徵
- **預付卡效期**：旅客卡多為 30 到 60 天，帶回來很快就失效，之後要靠境內加值或換卡
- **換插境內 SIM**：機器就跟你的境內身分綁在一起，乾淨機的意義同時消失
- **IMEI 會把兩個門號串起來**：同一台機器先用境外卡、回來再用境內卡，電信商側看到的是同一個 IMEI 底下換過兩個號碼
- **海關**：攜帶多支手機在多數地區不違法，但會增加被詢問的機會。工作機與私人機的區分有實際用途，比刻意藏起來合理
