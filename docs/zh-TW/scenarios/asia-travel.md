...
要降低當地政府當場把門號對應到你的風險，有效的做法是把對應留在境外，也就是通用準備裡的漫遊或純數據 eSIM。境外購買本身不提供匿名。

### 帶回台灣會發生什麼

這一節以帶回台灣為準。香港、澳門讀者的法規環境不同，回程若是中國大陸，答案幾乎是相反的，見下方的提醒。

- **境外門號在台灣漫遊**：你的位置持續回報給境外電信商，台灣的單位要對應到你通常得走跨境調取。代價是一個外國漫遊號碼長期在你住處附近活動，模式本身就是特徵
...
- **海關**：攜帶多支手機入境台灣不違法，也少被詢問。工作機與私人機的區分有實際用途，比刻意藏起來合理

!!! warning "回程是中國大陸時，上面幾條要反過來看"

    外國漫遊號碼在中國大陸不會比較低調，它在當地反而顯眼，也一樣落在監控範圍內，跨境調取的門檻不構成保護。入境時裝置本身可能被查，2024 年 7 月起新規授權國安人員檢查個人電子裝置。落地換插當地 SIM 要實名加人臉。攜帶多支手機在中國大陸的入境查機風險屬於本表的最高一級。這條路線的完整脈絡見 [在中國大陸的公開平台傳播資訊](./mainland-speech.md) 與上方逐地註記的中國大陸段。

### 比較實際的做法

- 裝置留著重複使用，每趟出發前重設，回來後不要拿它處理日常事務
- 不要在同一台機器上混用境外與境內門號
- 境內真的需要另一個門號時，在境內取得。實名這一層在境內同樣避不掉，台灣的預付卡登記要求見下方逐地註記的台灣段
