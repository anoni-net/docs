...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/travel-briefing-flow-v4.zh-TW.svg"
    ...
    <figcaption>AI 的回答是「該查哪些東西」的起點。這套流程適用任何目的地，跟「東亞東南亞出差」那篇互補。該篇給的是已經查證過的十四地對照，這一篇給的是自己查其他地方的方法。問完之後，行前準備照「出差與研討會的數位準備」的分層清單走一次，兩篇合起來才是完整的行前流程。</figcaption>
</figure>
