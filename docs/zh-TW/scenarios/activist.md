...
公開活動要有人來，資訊本來就得對外發。可以調整的是哪一項資訊什麼時候發，以及發給誰。

2026 年 9 月 Anthropic 的濫用偵測報告記錄了一批被封禁的帳號，與中國市級公安及國安機關有關，其中一項作業產出境外活動的前期場地情報，內容包含集合點、路線與終點。蒐集對象是溫哥華的一場民主遊行、土耳其的維吾爾文化活動與奧斯陸自由論壇的放映場次，三者都是合法公開的活動，蒐集發生在活動之前。報告把這一項列為該批案例裡最嚴重的一條，逐段整理見 [Anthropic 九月威脅報告寫到台灣的四個段落](../blog/posts/2026-anthropic-threat-report-taiwan.md)。
