...
- **郵件別名**：門檻最低的一種，公開一個轉寄別名而不是你的主信箱，對方用任何信箱都寄得進來，不必先學工具。防護力也最低，轉寄商看得到對方的原始寄件地址、時間與來源 IP，而所有別名都指向你同一個信箱，多個來源的關聯性集中在同一家業者手上。適合當「總比直接給 Gmail 好」的第一層入口，敏感度一升高就要引導對方換到上面幾種，取捨見 [郵件別名怎麼用，以及它把信任交給誰](../tools/email-alias.md)
