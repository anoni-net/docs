...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/source-attribution-levels-v2.zh-TW.svg"
        alt="四層由深到淺的橫條，代表記者與消息來源可以約定的四種引用層級，越往下來源的暴露面越小。第一層是具名，意思是可以寫出姓名與職稱，報導裡會出現姓名、職稱與原話。第二層是匿名引用，意思是可以引述內容但用角色代稱，報導裡會出現像「一位參與該專案的工程師表示」這樣的句子。第三層是背景，只用來理解事情與指引查證方向，來源不出現也不被引述。第四層是不使用，內容完全不進入報導。下方的紅框提醒匿名引用最容易出事，因為代稱本身可能就足以指認，一家公司裡符合描述的只有三個人時，代稱等於點名了三個人。">
    <figcaption>逐段確認，不要整場談完之後才一次確認。不要承諾做不到的事。可以承諾的是具體行為：不交出紀錄、不在編輯部以外提到他、報導刊出前讓他看過涉及他的段落。</figcaption>
</figure>
...
- 不要為了安全把對方推到他無法使用的工具上。無法使用的工具等於沒有工具，對方會退回最方便的管道，那通常最不安全
...
前面幾節處理的是保護消息來源。這一節處理另一種情況，記者本人被當成情報目標。

2026 年 9 月 Anthropic 的濫用偵測報告記錄了兩種與記者直接相關的手法。一是側寫與反制檔案，報告第 78 頁寫，一個與阿聯酋相關的行動對 18 名歐洲議會議員與知名記者做了徹底的研究與側寫，並對批評過阿聯酋在蘇丹作為的聯合國特別報告員彙整反制檔案。二是帳號被複製，第 70 頁寫，一個與伊朗反對運動相關的行動指派共用的 AI 代理複製一名真實運動者的 Telegram 帳號，用波斯語與他的聯絡人即時對話，報告寫就他們所知，那些聯絡人並不知道自己在跟一個 AI 輔助的帳號說話。逐段的頁碼對照見 [Anthropic 九月威脅報告寫到台灣的四個段落](../blog/posts/2026-anthropic-threat-report-taiwan.md)。

經常與國際人權機制往來、也常接受採訪的人，手法的重疊度最高。

### 事前約好一個驗證方式

被冒充的時候，能保護你的是身邊的人怎麼辨識。這件事要在事前做：

- 跟固定往來的來源、編輯與同業約好一個驗證方式，共用的驗證詞，或者換一個管道回撥
- 換聯絡管道時，用舊管道宣告一次，不要只從新管道單方面出現
- 對方的語氣、要求或節奏突然改變時先停下來確認，尤其是索取新檔案、要求改用新平台、催你立刻回覆這三種
- [網路中斷時的準備與應對](./shutdown.md) 裡跟聯絡人約定會合與驗證方式用的是同一套邏輯，兩邊可以共用同一組約定

### 定期看自己的名字被拿去做什麼

- 每季用自己的姓名、慣用 ID 與服務的媒體名稱搜尋一次，包含各社群平台的帳號搜尋
- 發現被複製的帳號時，先通知常用聯絡人，再向平台檢舉。檢舉之前把截圖與網址留下來
- 被冒充影響到的是你的聯絡人，通知他們的優先順序高於平台處理的速度

### 跨國協作的私人群組

跨境調查經常靠私人群組維持，報告第 83 頁引述的商業監控廠商服務內容，第一步就是用假帳號混進私人群組再收割成員清單。成員驗證的具體作法見 [社運行動者的數位準備](./activist.md) 的跨國協作群組的成員驗證一節，記者這一端額外要注意的是，群組裡不要放來源的代號對應表與完整聯絡名單。

### 被建檔跟被處置是兩件事

記者本人被寫進檔案，下一步通常是列入名單與持續追蹤。實際會不會受到影響，跟本人或所屬媒體會不會進入對方轄區的關聯更大。這一層的能力邊界見 [監控現在做得到什麼](../basics/surveillance-capability.md) 的公開來源的情報建檔一節。
