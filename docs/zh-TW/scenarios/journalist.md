...
多數數位安全指引預設對方能自己裝 Signal、清 metadata、開 Tor Browser。實際上高齡、視聽功能退化、沒有智慧型手機使用習慣的來源不少。硬要對方學新工具，結果通常是裝錯、設錯，或者乾脆放棄聯繫。
...
- 帶紙筆，重要的名字、日期、數字寫下來給對方確認，比重複問更省時也更準確
- 一次談的時間放短，兩次短談比一次長談有效
- 不要在對方家裡留下紙條、工具說明或你的名片。這些東西你走了以後還在

### 必要的通訊用最低門檻的方式

- 市話與簡訊會留下通聯紀錄，但對方真的能用。對手是公司內部調查、而非能調閱通聯紀錄的執法單位時，這個取捨可以接受
...
同一個題目有兩個以上的來源時，記者手上就多了一個責任：不讓來源之間互相知道彼此存在。
...
這是最容易洩漏的一步。你把 A 提到的細節拿去問 B，B 就知道有人提供了消息，而且從細節的內容多半能猜到是誰。

- 求證時把細節抽象化，問「據我了解當時的流程是這樣，對嗎」，不要複述原話
- 只有少數人知道的事，換個問法從公開資料或制度面切入，不要直接拋出來
- 真的需要用具體細節求證時，先評估這個細節會指向誰，再決定要不要問
- 對方主動說出跟 A 一樣的細節，才算真正的獨立佐證

### 報導細節的來源指紋

寫稿時同樣的問題會再出現一次。某個只有特定職位、特定會議在場者才知道的事實，寫進報導等於指認。
...
前面的技術操作通用，涉及中國大陸的採訪要另外處理三件事：境內受訪者的法律風險、境內協作者的處境、記者離境後才開始的風險期。
...
- 境內通訊預設可被調取。微信沒有端對端加密，Signal、WhatsApp、Telegram 在境內被封鎖，受訪者要用得掛 VPN，而個人翻牆在境內屬違法灰色地帶
...
- 對方主動聯繫時，先確認是不是本人在操作
- 評估對方是否需要暫時離開，這個判斷交給有在地經驗的組織，不要自己下結論
