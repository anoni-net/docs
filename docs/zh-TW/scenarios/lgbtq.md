...
- **無跟蹤騷擾專法**：台灣的跟蹤騷擾防制法在香港沒有對應，香港至今未立反跟蹤騷擾罪，被起底、跟騷時只能援引民事侵權、性騷擾或 2021 年新增的「起底」刑事罪名間接處理。前面「已被跟蹤騷擾時」一節依賴跟騷法的救濟路徑，對香港讀者會落空。
- **本地支援組織仍運作**（相較政治性團體受國安法衝擊較小）：可查香港本地的 LGBTQ+ 支援與心理服務組織，數位安全求助同樣可找 [Access Now Helpline](https://www.accessnow.org/help/){target="_blank"}。

查證來源（2026-07）：[Registration of Same-sex Partnerships Bill](https://en.wikipedia.org/wiki/Registration_of_Same-sex_Partnerships_Bill){target="_blank"}、[Recognition of same-sex unions in Hong Kong](https://en.wikipedia.org/wiki/Recognition_of_same-sex_unions_in_Hong_Kong){target="_blank"}、[Stalking](https://familyclic.hk/en/category/topics/daily-lives-legal-issues/stalking/){target="_blank"} - Family CLIC。
