...
> 版本 `2026090500`、`2026090700`、`2026091000` · [官方發布頁](https://grapheneos.org/releases){target="_blank"}

- 安全修補等級在 9 月 10 日推進到完整的 2026-09-01 Pixel 等級。Google 的九月公告在 9 月 8 日恢復列出漏洞明細，該月的內容整理在 [Android 安全修補等級](./android.md)。
- 電話（Dialer）加入自動通話錄音。9 月 5 日先做成每通可以退出的開關，來電與去電都涵蓋，通話中會顯示正在錄音的提示。9 月 10 日補上「預設對所有聯絡人錄音，另外維護一份排除號碼清單」的選項，同時宣告麥克風與電話的前景服務類型，修好用藍牙接聽時錄音不會啟動的問題。通話錄音在許多地區涉及法律問題，開之前先確認自己所在地的規定。
...
- Vanadium（GrapheneOS 內建的強化版 Chromium 瀏覽器）到 9 月 5 日那一版為止累積了四次更新，跟上 Chromium 152 系列。
- 核心三條線（6.1、6.6、6.12）都跟上 GKI LTS 的最新修訂。6.6 與 6.12 另外繞過上游 arm64 KVM 的一個錯誤，那個錯誤會讓開了 lockdown 機密模式的裝置開不了機。
