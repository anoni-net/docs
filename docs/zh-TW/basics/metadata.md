...
「我用了端對端加密，沒人讀得到我的訊息，所以是安全的吧？」這句話的問題不在前半段，而在後半段。Metadata 就是後半段缺的那一塊。
...
Metadata 不是某一處集中產生的，是各種日常行為的副產品。常見來源：
...
- 把 metadata 這個維度帶進 [威脅模型怎麼想](./threat-model.md)，問自己「我的對手能看到什麼樣的 metadata」
