...
威脅模型不是一份要寫得多正式的文件，而是一個你願意定期回頭檢視的小清單。它幫你在每次選工具、決定行為、評估風險時，能回答三個基本問題。
...
- **資訊**：你的本名、住址、職業、家人位置；私人對話、未公開的相片、研究中的草稿；登入憑證、銀行帳戶、加密貨幣金鑰
...
這個分級不是要嚇人，是要讓工具選擇對應到實際能力範圍。對手是親密關係的人，你不需要 Tor，你需要把裝置鎖好、把雲端帳號的密碼換掉、把 Find My 關掉。對手是大規模平台收集，你不需要 air-gap 電腦，你需要選擇預設不蒐集 metadata 的通訊工具。
