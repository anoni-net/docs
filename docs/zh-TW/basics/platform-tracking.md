---
title: 社群平台怎麼收集你的資料
description: 平台實際取得哪些資料、精準廣告怎麼算出來的，以及「手機在偷聽我說話」這個感覺從哪裡來。
icon: material/radar
---

# :material-radar: 社群平台怎麼收集你的資料

跟朋友聊到某個東西，隔天社群就推那個東西的廣告。這個經驗太常見，最直覺的解釋是手機在偷聽。

這頁先說明平台實際取得哪些資料，再回頭看麥克風這個解釋成不成立。順序這樣安排是有原因的：真正在發生的收集，比偷聽更全面，也更難察覺。

## 平台實際取得什麼

### 你主動給的

帳號資料、貼文、按讚、追蹤名單、加入的社團、搜尋過的關鍵字。這一層最直覺，多數人也預期得到，但它只佔全部的一小部分。

### 裝置與連線

打開 app 或網頁的當下，對方就取得 IP 位址、裝置型號、作業系統版本、螢幕解析度、語言與時區設定、電池狀態、已安裝字型清單。這些組合起來就是裝置指紋，即使你登出、換帳號、開無痕模式，同一台裝置多半仍認得出來。

### 行為訊號

這一層最容易被低估。平台記錄的不只是你做了什麼，還包括你怎麼做：
...
單一平台看到的資料有限，真正的規模來自跨站追蹤。EFF 的《Behind the One-Way Mirror》把這套技術整理得很完整，包括看不見的追蹤像素、瀏覽器指紋、社群外掛按鈕、行動端追蹤與人臉辨識[^eff]。幾個常見的機制：
...
- **位置共現**：兩台裝置反覆在同一時間出現在同一地點，這個關係本身就有廣告價值
...
這件事成立的範圍是語音助理，也就是你本來就授權它聽喚醒詞的功能。它不等於社群 app 常態竊聽。

### 大規模研究沒有找到偷錄音的證據

2018 年一份發表在 PETS 的研究測試了 17,260 個 Android app，觀察它們是否在使用者不知情的狀況下啟用麥克風並外傳音訊。結果沒有找到這樣的證據。研究團隊反而發現另一件事：有些 app 會錄下使用者的螢幕畫面並傳給第三方，而 Android 當時對這個行為沒有要求權限[^panoptispy]。

這個發現正好說明為什麼麥克風不是重點。真正在發生的收集，用不到麥克風也做得到，而且沒有觸發任何權限提示。
...
- **關掉通訊錄上傳**。這一項同時保護你的聯絡人，他們沒有同意被上傳
...
平台的設定介面與政策每幾個月就改版，法規也在變。這裡寫的是機制與方向，實際操作前請以各平台當下的官方隱私設定頁為準。發現本頁描述已經跟現況不符，歡迎到 [社群 Matrix 公開 room](../community/tools.md) 回報。
