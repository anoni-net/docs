...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/fingerprint-funnel-v4.zh-TW.svg"
        alt="一個由上往下收窄的漏斗，分成六階。最上面一階最寬，代表所有瀏覽器。往下每一階加入一項瀏覽器指紋的特徵，人群就縮小一次：加上時區之後剩下同一個時區的人，加上語言與作業系統之後還是很多人，加上螢幕與視窗尺寸之後範圍明顯縮小，加上繪圖硬體之後剩下不多，加上完整的字型清單之後常常就只剩你一個。每一階的寬度是示意，不是量測到的數字。底下註記 EFF 在 2010 年的 Panopticlick 研究收集了 470,161 個瀏覽器樣本，其中 83.6% 的指紋是唯一的。">
