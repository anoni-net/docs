...
const GAME_APPS = [
  ...
  // 各國行政區。平常貼近那一國才抓，離線時沒有網路可抓，所以跟著預快取。
  // 產生器新增一國時要補一行，tools/check_admin1.mjs 會對照索引檢查。
  "games/tor-network/play/admin1/index.json",
  "games/tor-network/play/admin1/bn.json",
  "games/tor-network/play/admin1/hk.json",
  "games/tor-network/play/admin1/id.json",
  "games/tor-network/play/admin1/jp.json",
  "games/tor-network/play/admin1/kh.json",
  "games/tor-network/play/admin1/kr.json",
  "games/tor-network/play/admin1/la.json",
  "games/tor-network/play/admin1/mm.json",
  "games/tor-network/play/admin1/my.json",
  "games/tor-network/play/admin1/ph.json",
  "games/tor-network/play/admin1/sg.json",
  "games/tor-network/play/admin1/th.json",
  "games/tor-network/play/admin1/tl.json",
  "games/tor-network/play/admin1/vn.json",
