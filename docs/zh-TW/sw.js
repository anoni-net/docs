...
//
// 2026-09 國界與海岸線換成 Natural Earth 10m，那兩份從 261 KB 變成 1,092 KB，
// 這一批因此多了 831 KB。換的理由是站上的讀者多半在東亞，而粗的比例尺下日本與
// 菲律賓的島鏈只是幾個點連成的折線，放大之後看起來是一段一段的方塊。
//
// 東亞的海岸線留到約 220 公尺，其餘亞洲與世界其他逐級放粗；國界另外用一組較粗的
// 參數，那一份只拿來判六角格的國碼與畫底圖。海岸線改存成折線而不是獨立線段，
// 相鄰段共用端點，光那一項就省了 62%。
//
