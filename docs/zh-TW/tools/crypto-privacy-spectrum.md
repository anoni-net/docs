...
對台灣使用者的判斷重點：技術本身沒有犯罪化，「協調服務」與「混幣輸出」在多數司法管轄會引發合規關切。詳細案例分析見 [倡議組織的匿名捐款管道](../scenarios/nonprofit-anonymous-donation.md) 的 Tornado Cash 段落。社群目前的立場是把這條路線當作背景知識，不再做為主推工具。在香港，除了同樣的合規關切，還要把國安監控擴大後的政治風險層算進來，與敏感資金流沾邊的行為可能引來額外注意。美國 2025–2026 市場結構立法的整體脈絡，詳見 [台灣 VASP 法 2026](../taiwan/vasp-2026.md) 的國際對照段。
...
!!! info "在地脈絡：香港 VATP 發牌制度（已生效）"
    ...
    香港的階段跟台灣不同。台灣的 VASP 法還在立法收緊的過程，香港則自 2023 年 6 月起已實施 VATP（虛擬資產交易平台）發牌制度，由證監會（SFC）依《證券及期貨條例》監理。散戶只能在持牌平台交易符合資格的代幣，Monero、Zcash 這類隱私幣因與 AML/KYC 要求衝突，實務上幾乎無法在持牌平台上架。也就是說，香港的收緊已是現行法，台灣則仍在立法過程中[^hk]。
