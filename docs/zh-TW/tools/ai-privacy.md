...
前面三家的分野（消費版可能訓練、企業版預設不訓練）是中國境外服務的通則。DeepSeek、豆包、Kimi、通義等在中國境內提供的生成式 AI 服務適用另一套規則，前面的判斷方式不能直接套用。本節的「境內」、「境外」都以中國為界。

《生成式人工智慧服務管理暫行辦法》2023 年 8 月 15 日施行，由網信辦會同六個部門發布[^cn-genai]，跟工作使用直接相關的規定有：
