...
!!! warning "香港讀者：參與前先評估風險"
    ...
    同樣的技術在香港可行，但參與前要把國安監控算進來。Snowflake 把你的瀏覽器變成替他人轉發 Tor 流量的節點，在 2020 年《國安法》與 2026 年 3 月生效的裝置解密義務（持令狀調查國安案時可要求交出裝置密碼，拒絕最高一年徒刑）之下，一旦裝置被搜查，「為什麼你的瀏覽器在幫審查地區的人連 Tor」本身可能引來額外關注。技術上合法、可用，脈絡見 [VPN 的風險與選擇](./vpn-guide.md) 的香港小節。
