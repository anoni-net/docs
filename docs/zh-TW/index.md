...
我們計劃使用 Tor、Tails 和 OONI 等開源匿名工具，增強在網路上的匿名性與安全性，也希望**新聞媒體**、**獨立記者**、**公民團體**與**開源科技社群**有更多機會協作與交流。

我們特別關注這幾類參與者，是因為他們在實務上往往要同時面對消息來源與成員的保護、跨境查證時能不能順利連線，以及能不能用開放觀測把封鎖、降速或施壓說清楚。

- **新聞媒體**：降低採編過程中身分與流量被比對、追蹤的風險，並在連線受阻時仍能查證與對外說明。
- **獨立記者**：在資安與法律支援有限時，更仰賴匿名網路與以隱私為重的使用環境來完成調查與聯繫。
