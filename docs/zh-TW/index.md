...
## :material-wifi-off: 沒有網路也能讀

整個文件站可以存進手機或電腦。用一般瀏覽器開過並選一次閱讀語言，核心章節就會在背景存進裝置，斷網時照樣能打開。要把整站帶著走、挑選要留哪些頁面，或裝成有自己圖示的 App，照[離線閱讀](./offline.md)的三個步驟做，最後用飛航模式確認一次。Tor Browser 與 onion、IPFS 版基於隱私考量不提供這項功能。

[:material-wifi-off: 離線閱讀](./offline.md){ .md-button .md-button--primary }
