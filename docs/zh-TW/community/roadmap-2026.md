---
title: 2026 年度路線圖
description: 2026 年匿名網路社群 anoni.net 的三大主題、文件站建設節奏、活動規劃與如何加入。
icon: material/road-variant
---

# :material-road-variant: 2026 年度路線圖

這頁列出 2026 年匿名網路社群 anoni.net 的年度目標與季度交付物，是給夥伴、合作者與外部關注者的對外說明版。新的一年我們會持續以「匿名網路」為核心，除了延續 Tor、Tails、OONI 的在地推廣，也會聚焦三個新的推進項目：個人隱私指引、Tor Relay 校園建立、匿名支付的應用與探索。每一季結束會檢視交付狀況，並調整下一季的安排。
...
文件站是社群推廣與沉澱的核心工具。架構已重整為 7 大分類加上指南 5 個子群組（概念、工具、場景、進階、報告），一年的內容填補節奏與當前進度：

- **Q1（已完成）**：基礎概念（[basics](../basics/index.md)）優先補齊、在地法規類（[個資法 2025 修法](../taiwan/pdpa-2025.md)、[VASP 2026](../taiwan/vasp-2026.md)）、緊急求救頁、社群治理與路線圖
- **Q2（進行中）**：工具層（Tor Browser 進階、匿名作業系統比較、通訊工具比較、密碼管理器、加密貨幣隱私光譜）、進階層的端對端加密，各篇初稿已上線、持續校訂
- **Q3（待開始）**：場景層（記者、社運、家暴倖存者、LGBTQ+、選舉觀察員等）、進階層的後量子與去中心化發布、揭弊者保護法觀察
- **Q4（待開始）**：社群治理章程、貢獻者百科、年度回顧
