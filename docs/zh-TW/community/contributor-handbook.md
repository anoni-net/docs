...
如果你是第一次參與，建議先看 [如何參與與認領主題](./how-to-contribute.md) 決定方向，再回來這頁查具體做法。完整的工具入口與帳號申請見 [溝通與協作工具](./tools.md)。
...
- **想開始寫作或翻譯**：申請 Matrix 帳號（見 [溝通與協作工具](./tools.md)）→ 加入 Public Space → 表達意願 → 認領一個 Issue
...
| 怎麼申請 Matrix 帳號？ | [溝通與協作工具](./tools.md) |
