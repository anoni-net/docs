...
需要寫對外完整網址時（社群貼文、外部引用），站台預設語系 zh-TW 不帶語系區段：`docs/zh-TW/community/i18n.md` 對應 `https://anoni.net/docs/community/i18n/`。zh-CN 用小寫 `https://anoni.net/docs/zh-cn/...`，en 用 `https://anoni.net/docs/en/...`。資料夾路徑仍保留語系大小寫。
