...
固定的數字只有幾個：畫布 400 寬，外距 12，卡片內距 14，所以文字可用寬度是 348。卡片上緣到第一行文字 24px，行距 17px，卡片之間 10px，需要分段時放大到 14px。標籤與節點的圓角 rx 是 6，卡片是 8。
...
連接線   M200 y V y+12
箭頭     M195.5 y+11 L204.5 y+11 L200 y+18 Z
```
