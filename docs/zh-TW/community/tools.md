...
- **帳號申請**：目前 Cryptpad 帳號亦需來信 <whisper@anoni.net> 申請，預設提供 50 MB 的容量，未來可調整。
...
- **服務**：[https://jitsi.goodmeet.asia/](https://jitsi.goodmeet.asia/){target="_blank"}（免費使用，第三方提供、非社群自架，條款與可用性依對方為準）。
