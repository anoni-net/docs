...
匿名與網路自由放在台灣談，問題意識跟歐美不一樣。台灣沒有像中國長城防火牆那種系統性的大規模網路封鎖，網路自由度在亞洲名列前茅，但觀測資料集中在少數幾家電信商、個資法與虛擬資產監理正在重修、揭弊者保護法剛上路，這些都是放回在地才看得清楚的題目。這個分類沿用 [網路自由為什麼重要](../basics/internet-freedom.md) 提到的三個面向：連線層、個資與身分、金流，依這三個面向整理台灣的觀測資料、法規動態與制度討論。內容適合給研究者、記者、倡議組織，或對在地政策有興趣的讀者，當作切入觀察的起點。
