...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/ipfs-vs-onion-v2.zh-TW.svg" alt="IPFS 與 Onion 架構對照。IPFS 走 gateway → DHT → peer，主要解決抗刪除。Onion 走 Guard → Middle → Rendezvous → HSDir → 服務，主要解決連線匿名">
</figure>
...
<figure markdown="span">
    <img class="diagram-tall" src="https://assets.anoni.net/diagrams/anoni-deployment-v2.zh-TW.svg" alt="anoni.net 文件站三軌部署：同一份 GitHub repo 透過三套 build script 處理路徑差異，分別部署到主站 anoni.net、IPFS 網路、.onion 隱藏服務">
</figure>
