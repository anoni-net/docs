...
雖然該公司將自己定位為一家標準的資安公司，實際上卻是在向哈薩克斯坦、衣索比亞、巴基斯坦和緬甸，以及未具名的 A24 客戶（政府），出售類似於防火長城的能力。它也在與中國的地區政府合作。這些技術包括深度封包檢測、位置追蹤、流量監控、網站和 VPN 封鎖、使用者識別、聲譽評分，甚至惡意軟體部署。這些工具方便地與現有基礎設施整合，並直接透過網路服務提供商運作。公司對使用者數據如何收集、儲存或共享，沒有提供道德保障或透明度，這對資料主權造成嚴重顧慮，因為公司員工似乎可存取使用者資訊。
...
同樣地，ATOM 不會透露操作安全的時間表及/或供應商具體資訊。我們的合規性由緬甸法律和監管義務驅動，這面臨許多全球地區的管轄，這包括執行合法指令和實施技術能力的能力，這是由官方機構及/或監管機構所要求的。我們與提到的供應商並沒有任何合約關係。
