...
台灣公司凌華科技（ADLINK Technologies）向中國公司 Geedge Networks 出貨超過 1,700 台專用網路硬體設備，Geedge Networks 是一家為各國政府打造與輸出國家級網路審查與監控系統的中國公司。凌華科技向 InterSecLab 證實了這批出貨紀錄，並說明其出口合規程序並未識別出最終用途，原因是 Geedge 並未揭露。這批硬體最終部署於哈薩克，用以運作 Geedge 的天狗安全閘道（Tiangou Secure Gateway，TSG），其能力可媲美中國防火長城（GFW）。
...
凌華科技的出口合規審查未對「向中國公司出貨超過 1,700 台專用網路設備」提出警示，儘管這款硬體本身就是為支撐網路審查的深度封包檢測而設計。凌華向 InterSecLab 表示，Geedge 在採購過程中並未揭露最終應用。
