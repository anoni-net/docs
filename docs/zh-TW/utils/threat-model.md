...
有一種情況不提供存檔：對手選了親密關係、一國執法或國家級。他們能接觸到你的裝置，也可能要求你解鎖，passkey 沒有比螢幕鎖更強。密碼管理器另設主密碼而且已經鎖上時多一道，但別把安全押在這上面。「我要防的是親密關係的人」這種答案留在對方能接觸到的裝置上，正好是最不該留的東西。那時只剩「複製摘要」，貼到對方碰不到的地方。
...
跟這一區其他工具一樣，程式存進裝置之後沒有網路也能用。網域被封、連線被切之後還可以開啟，正是這份清單最需要被打開的時候。
