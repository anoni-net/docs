...
summary: "香港的入境查機風險由中升到高、日本境外 eSIM 的例外拿掉、推薦過的 2FA app 換了經營者、台灣封鎖判定的分布被全量資料推翻。7/27 到 8/07 之間文件站併入 45 個 PR，相當比例花在改自己寫錯的地方。以下按頁介紹改了什麼、依據在哪裡，以及照著舊版做過準備的人要補上的五件事。"
description: "香港的入境查機風險由中升到高、日本境外 eSIM 的例外拿掉、推薦過的 2FA app 換了經營者、台灣封鎖判定的分布被全量資料推翻。7/27 到 8/07 之間文件站併入 45 個 PR，相當比例花在改自己寫錯的地方。以下按頁介紹改了什麼、依據在哪裡，以及照著舊版做過準備的人要補上的五件事。"
---
...
近兩週有幾頁的內容被改掉，改法多半是把先前寫過的整段撤回。香港的入境查機風險由中升到高、日本境外 eSIM 的例外拿掉、推薦過的 2FA app 換了經營者、台灣封鎖判定的分布從 40 筆抽樣換成 22,105 筆全量重算。7/27 到 8/07 之間文件站併入 45 個 PR，相當比例花在這類更正上。以下按頁介紹改了什麼、依據在哪裡，中段有一份清單，寫給照著舊版做過準備的人。
