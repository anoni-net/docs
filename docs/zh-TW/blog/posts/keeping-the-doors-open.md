...
summary: "Unredacted 用 300+ 台伺服器跑 FreeSocks、Tor bridges、Snowflake 等抗審查服務，並用約 400W 維運 123 個 Tor exit relay。對照台灣目前 12 個 Tor 中繼節點（其中 3 個是 exit）的現況，正體中文社群處在能撐傘的位置。"
description: "Unredacted 用 300+ 台伺服器跑 FreeSocks、Tor bridges、Snowflake 等抗審查服務，並用約 400W 跑 123 個 Tor exit relay。對照台灣 12 個 Tor 中繼節點的現況，我們處在能撐傘的位置。"
---
