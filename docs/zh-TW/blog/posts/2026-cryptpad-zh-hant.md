...
summary: "CryptPad 是少數讓伺服器看不到內容的線上協作工具，介面過去缺少正體中文。anoni.net 社群花兩年半在 CryptPad 上游做翻譯，2026/05 隨 CryptPad 2026.5.0 收進內建語系。加密協作工具的語言門檻消失，正體中文使用者（無論在台灣、香港、澳門或其他華語環境）能把它放進日常選項。"
description: "CryptPad 是少數讓伺服器看不到內容的線上協作工具，介面過去缺少正體中文。anoni.net 社群花兩年半在 CryptPad 上游做翻譯，2026/05 隨 CryptPad 2026.5.0 收進內建語系。加密協作工具的語言門檻消失，正體中文使用者（無論在台灣、香港、澳門或其他華語環境）能把它放進日常選項。"
---
...
翻譯一套線上協作工具的介面，不像翻一篇文章。CryptPad 主應用、Accounts plugin 與 User Guide 加起來上千條字串，每一條都要對齊它在介面上會出現的情境、顧及上下文、避免在「儲存」「另存新檔」這類詞之間混用。再加上 CryptPad 還在持續開發，新功能會帶來新字串，每個版本上線前都得回頭再校一輪。
