...
[^snowden]: 2013 年，前美國國家安全局（NSA）的承包商愛德華·斯諾登（Edward Snowden）揭露了一系列秘密文件，指出美國政府如何大規模監聽和收集全球數據。爆料引起了全球對網際網路監控規模和範圍的高度關注。斯諾登的揭露顯示，美國不僅進行國內監控，還可能涉及全球通信的監視，直接牽涉到國際監控網絡及 ISP 的作用。
