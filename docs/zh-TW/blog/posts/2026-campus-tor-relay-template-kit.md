...
2025/11，台灣第一個校園 Tor Relay 在台師大資工系上線。社群這半年想做的事情很具體：把那段「跟學校溝通、走 TANet 行政流程、技術部署、長期維運」的經驗整理成其他學校可以直接拿去用的文件，不要再讓每一所學校的學生從零開始摸索。
...
如果你正在自己學校推動、卡在某個環節想找人討論，或者已經有想法但不知道怎麼跟教授開口，任何一個階段都歡迎聯繫社群。常用入口整理在[社群自架服務](../../community/tools.md)頁面，Matrix 公開 room 也可以直接打招呼。
