...
除了機器本身，他也曾在校內社團舉辦匿名網路相關活動，介紹 Tor、匿名通訊與其背後的設計理念。即使參與人數不一定多，但至少讓「**匿名網路 ≠ 犯罪工具**」這件事，有機會在校園被好好講清楚，跳出刻板印象。
...
!!! question "延伸思考：為什麼這樣的嘗試，值得被留下來？"
    ...
    讀完這段訪談，我們很容易把焦點放在「**他做成了什麼**」。但對匿名網路社群來說，真正值得記下的，是「**這件事是怎麼被做成的**」。
