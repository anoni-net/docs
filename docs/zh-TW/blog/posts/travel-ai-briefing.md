...
所以我們新做了一頁，把這些「該問的問題」整理成一包可以直接複製的 prompt。你複製後帶回去問你自己信任的 AI（你平常用的 ChatGPT、Claude，或自行架設的本地模型都行），讓它幫你把目的地的審查、法律、SIM 與緊急聯絡整理成一份行前概況。

分工之後，你的目的地和身分這種敏感資訊不會送到我們的伺服器。要問什麼是公開、固定的，誰都能檢查。同一包問題對任何國家都適用，換一個目的地不用重來。
