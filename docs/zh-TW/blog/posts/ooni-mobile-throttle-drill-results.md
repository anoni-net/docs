...
|---|---:|---:|---:|
| `13:32` | `89,510` | `21,510` | `138,513` |
| `13:33` | `174,682` | `16,348` | `119,179` |
| `14:36` | `788` | `26,300` | `1,308` |
| `14:39` | `881` | `31,789` | `1,608` |
| `14:51` | `1,565` | `22,370` | `1,624` |
| `14:52` | `1,709` | `32,695` | `821` |

三個數值欄的單位都是 kbit/s，數字越大越快。下載與上傳來自連線速度測試，影音串流位元率是串流測試估算出來的可播放品質，`1,308` kbit/s 大致相當於標準畫質，`138,513` kbit/s 遠超過手機播放所需。
...
|---|---:|---:|---:|
| `13:32`（降速前） | `18.39` | `66.78` | `0.000%` |
| `13:33`（降速前） | `17.85` | `82.05` | `0.001%` |
| `14:36` | `16.85` | `168.40` | `0.522%` |
| `14:39` | `19.97` | `137.24` | `0.202%` |
| `14:51` | `18.72` | `130.05` | `0.000%` |
| `14:52` | `18.28` | `114.79` | `0.000%` |

兩個 RTT 欄的單位是毫秒（ms），數字越小代表來回一趟越快。最小 RTT 取整段測試中最快的一次，接近線路本身的實際距離。平均 RTT 把途中排隊的時間也算進去。重傳率是需要重送的封包所佔比例。
...
公告寫的結束時間是 `15:00`，最後一筆低速紀錄落在 `15:08`，實際恢復到堪用是 `17:47`。三個時間點各自代表不同的意思，中間隔了將近三小時。
