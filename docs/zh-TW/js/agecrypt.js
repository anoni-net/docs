...
(function () {
  ...
  const STRINGS = {
    "zh-TW": {
      ...
      backupHint: "這一欄是你自己的備援公鑰，要加密給別人把鑰匙切到「公鑰」。passkey 丟了只剩它能開。還沒有的話到 passkey 鑰匙頁產生，或按右邊的按鈕，私鑰只顯示一次。",
      genBackup: "產生備援金鑰",
      ...
      errors: {
        ...
        noPrf: "這把 passkey 算不出加密金鑰。到 passkey 鑰匙頁看說明。選單裡有不只一把 anoni.net 的話，先換另一把試。",
    ...
    zh: {
      ...
      backupHint: "这一栏是你自己的备援公钥，要加密给别人把钥匙切到「公钥」。passkey 丢了只剩它能开。还没有的话到 passkey 钥匙页生成，或按右边的按钮，私钥只显示一次。",
      genBackup: "生成备援密钥",
      ...
      errors: {
        ...
        noPrf: "这把 passkey 算不出加密密钥。到 passkey 钥匙页看说明。选单里有不只一把 anoni.net 的话，先换另一把试。",
    ...
    en: {
      ...
      backupHint: "This field is your own backup public key; to encrypt to someone else, switch the key to Public keys. If the passkey is lost, this is the only way in. Generate one on the passkey page, or with the button to the right. The secret is shown once.",
      ...
      errors: {
        ...
        cancelled: "You cancelled, or the browser did not finish. Press again.",
        noPrf: "This passkey cannot derive an encryption key. See the passkey page. If the picker lists more than one anoni.net passkey, try the other one first.",
