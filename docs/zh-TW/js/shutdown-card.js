...
(function () {
  ...
  const STRINGS = {
    "zh-TW": {
      ...
      sensitiveNote: "答案寫下來的話，撿到的人就能照著回答通過驗證。",
      addContact: "增加一位",
      removeContact: "移除",
      contactLimit: "最多五位。",
      modeTitle: "草稿要暫存在哪裡",
    ...
    zh: {
      ...
      sensitiveNote: "答案写下来的话，捡到的人就能照着回答通过验证。",
      addContact: "增加一位",
      removeContact: "移除",
      contactLimit: "最多五位。",
      modeTitle: "草稿要暂存在哪里",
    ...
    en: {
      ...
      hints: {
        ...
        verify: "Questions only. Both of you keep the answers in your heads.",
      },
      parts: {
        codename: "Code name",
      ...
      sensitiveNote: "An answer written down lets whoever finds the card read the reply straight off the page.",
