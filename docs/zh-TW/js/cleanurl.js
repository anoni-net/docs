...
(function () {
  ...
  const STRINGS = {
    "zh-TW": {
      ...
      note: "全部在你的瀏覽器裡處理，沒有把網址送到任何地方。短網址（t.co、bit.ly 這類）要連上去才知道指向哪裡，這一頁刻意不做那件事，那會把你想清理的網址送到第三方伺服器上。",
      owners: {
        utm: "廣告與電子報的來源追蹤",
    ...
    zh: {
      ...
      note: "全部在你的浏览器里处理，没有把网址送到任何地方。短网址（t.co、bit.ly 这类）要连上去才知道指向哪里，这一页刻意不做那件事，那会把你想清理的网址送到第三方服务器上。",
      owners: {
        utm: "广告与电子报的来源追踪",
