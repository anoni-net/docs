...
(function () {
  ...
  const STRINGS = {
    "zh-TW": {
      ...
      noPrf: "這個瀏覽器建得出 passkey，可是算不出加密金鑰。哪些保管方式行得通，見下面的「存到哪裡」。",
      ...
      errors: {
        ...
        noPrf: "這把 passkey 算不出加密金鑰。換一個保管方式再建一次，哪些行得通見下面的「存到哪裡」。",
    ...
    zh: {
      ...
      noPrf: "这个浏览器创建得出 passkey，可是算不出加密密钥。哪些保管方式行得通，见下面的「存到哪里」。",
      ...
      errors: {
        ...
        noPrf: "这把 passkey 算不出加密密钥。换一个保管方式再创建一次，哪些行得通见下面的「存到哪里」。",
    ...
    en: {
      ...
      noPrf: "This browser can create a passkey but cannot derive an encryption key from it. See \"Where to store it\" below for the options that work.",
      ...
      errors: {
        ...
        noPrf: "This passkey cannot derive an encryption key. Create another one somewhere else. See \"Where to store it\" below for the options that work.",
