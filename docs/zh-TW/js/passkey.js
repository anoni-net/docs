...
(function () {
  ...
  const STRINGS = {
    "zh-TW": {
      ...
      supported: "這個瀏覽器支援 passkey，也支援算金鑰用的 PRF 擴充。",
      maybe: "這個瀏覽器支援 passkey，PRF 擴充要等建立時才知道能不能用。",
      noWebAuthn: "這個瀏規器沒有 WebAuthn，用不了 passkey。Tor Browser 整個關閉了它，Firefox Android 也還不支援 PRF。",
      noPrf: "這個瀏覽器的 passkey 沒有 PRF 擴充，算不出金鑰。換一個瀏覽器，或把 passkey 存到支援 PRF 的密碼管理器。",
      ...
      errors: {
        ...
        noPrf: "這把 passkey 沒有 PRF 擴充，算不出金鑰。存到支援 PRF 的地方再試一次。",
        unsupported: "這個環境不允許 WebAuthn。要在 https 的正式站上，而且瀏覽器要開著 WebAuthn。",
    ...
    zh: {
      ...
      supported: "这个浏览器支持 passkey，也支持算密钥用的 PRF 扩展。",
      maybe: "这个浏览器支持 passkey，PRF 扩展要等创建时才知道能不能用。",
      noWebAuthn: "这个浏览器没有 WebAuthn，用不了 passkey。Tor Browser 整个关闭了它，Firefox Android 也还不支持 PRF。",
      noPrf: "这个浏览器的 passkey 没有 PRF 扩展，算不出密钥。换一个浏览器，或把 passkey 存到支持 PRF 的密码管理器。",
      ...
      errors: {
        ...
        noPrf: "这把 passkey 没有 PRF 扩展，算不出密钥。存到支持 PRF 的地方再试一次。",
        unsupported: "这个环境不允许 WebAuthn。要在 https 的正式站上，而且浏览器要开着 WebAuthn。",
    ...
    en: {
      ...
      supported: "This browser supports passkeys and the PRF extension used to derive keys.",
      maybe: "This browser supports passkeys. Whether the PRF extension works will only be known when you create one.",
      noWebAuthn: "This browser has no WebAuthn, so passkeys are unavailable. Tor Browser turns it off entirely, and Firefox on Android does not support PRF yet.",
      noPrf: "Passkeys in this browser lack the PRF extension, so no key can be derived. Try another browser, or store the passkey in a password manager that supports PRF.",
      ...
      errors: {
        ...
        noPrf: "This passkey has no PRF extension, so no key can be derived. Store it somewhere that supports PRF and try again.",
        unsupported: "This environment does not allow WebAuthn. It needs the https production site and a browser with WebAuthn enabled.",
