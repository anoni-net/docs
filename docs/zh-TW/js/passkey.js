...
(function () {
  ...
  const STRINGS = {
    "zh-TW": {
      ...
      noPrf: "這個瀏覽器建得出 passkey，可是算不出加密金鑰。換一個瀏覽器，或者把 passkey 存到 Bitwarden、1Password 這類支援的密碼管理器。",
      ...
      errors: {
        ...
        noPrf: "這把 passkey 算不出加密金鑰。把它存到 Bitwarden、1Password 這類支援的地方再試一次。",
    ...
    zh: {
      ...
      noPrf: "这个浏览器创建得出 passkey，可是算不出加密密钥。换一个浏览器，或者把 passkey 存到 Bitwarden、1Password 这类支持的密码管理器。",
      ...
      errors: {
        ...
        noPrf: "这把 passkey 算不出加密密钥。把它存到 Bitwarden、1Password 这类支持的地方再试一次。",
    ...
    en: {
      ...
      noPrf: "This browser can create a passkey but cannot derive an encryption key from it. Try another browser, or store the passkey in a manager that supports it, such as Bitwarden or 1Password.",
      ...
      errors: {
        ...
        noPrf: "This passkey cannot derive an encryption key. Store it somewhere that supports it, such as Bitwarden or 1Password, and try again.",
