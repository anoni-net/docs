...
(function () {
  ...
  const STRINGS = {
    "zh-TW": {
      ...
      badgeAuto: "網站已存",
      onlyStored: "只列已經存下來的",
      legend: "淡色的標題還沒存到這台裝置，沒有網路時無法開啟。勾選框是灰的表示那一頁由網站自動存著，那一份跟著網站版本走，網站換版時會被清掉重來，要確保它留在裝置上就按上面的「全部存到裝置」。",
      onlyStoredEmpty: "這個語言目前沒有存下任何頁面。",
      notStored: "還沒存到這台裝置，沒有網路時無法開啟",
    ...
    zh: {
      ...
      badgeAuto: "网站已存",
      onlyStored: "只列已经存下来的",
      legend: "淡色的标题还没存到这台设备，没有网络时无法打开。勾选框是灰的表示那一页由网站自动存着，那一份跟着网站版本走，网站换版时会被清掉重来，要确保它留在设备上就按上面的「全部存到设备」。",
      onlyStoredEmpty: "这个语言目前没有存下任何页面。",
      notStored: "还没存到这台设备，没有网络时无法打开",
