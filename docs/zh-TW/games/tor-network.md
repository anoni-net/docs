...
開場載起來的是地球本身、海底地形、Tor 中繼與連線受阻，另外十一層擺在左側面板最上方那一排格子裡。按一下才去抓那一份資料並畫上去，再按一下收回去，沒按過的層完全不佔流量。

十四份資料壓縮後合計 800 KB，開場那四層佔 429 KB，也就是進來先付一半多一點。其餘十一層裡最重的兩塊是海岸線 237 KB 與台灣那五層 95 KB。海岸線只是把海陸交界描得更銳利，沒有它的時候國界與陸地填色照樣分得出海陸，所以它排在按需那一邊。

開關之後網址會跟著變，複製網址列給別人，對方打開看到的疊法跟你一樣。也可以直接寫，`?layers=tw-power,tw-grid` 只開變電所與電網，空的 `?layers=` 只留地球本身。

按下「開始導覽」的時候，七站要用的層會自己補載，不必事先一格一格點開。
...
- **上網人口**：該國有多少比例的人上網，World Bank 收了 208 個經濟體，比中繼涵蓋得廣

指標由資料層供應，所以那一排按鈕會跟著開關增減。前三個來自 Tor 中繼那一層，使用者估計與上網人口各自要先把對應的層打開才會出現。停在某個指標上而把供應它的層關掉的時候，畫面會自己換回中繼台數。

使用者估計與上網人口擺在一起看才完整。前者是絕對人數，後者是那個數字的分母，兩個對照才分得出某一國的差距來自需求還是人口規模。
...
### 東亞與東南亞的行政區界線（DATA.GOV.HK、Natural Earth public domain）

貼近日本、韓國、香港或東南亞各國時，陸地上會淡入一層細線，例如日本的都道府縣、韓國的道與廣域市、香港的 18 區，以及越南、泰國、菲律賓、印尼等十一國的省與州，跟貼近台灣時出現縣市界是同一件事。每一國的界線是一份獨立的小檔案，鏡頭貼近那一國才去抓，一個典型的行政區在螢幕上夠大了才畫出來，所以日本的縣比香港的區早出現。只畫相鄰兩區共用的那條邊，外框交給國界與海岸線，有主權爭議的孤立島嶼因此不會被畫進任何一國。香港的區界來自[香港特別行政區政府民政事務總署](https://data.gov.hk/tc-data/dataset/hk-had-json1-hong-kong-administrative-boundaries)，經 DATA.GOV.HK 發布，依[使用條款](https://data.gov.hk/tc/terms-and-conditions)使用。原資料把海面也分給各區，這裡只留陸地上的部分。其餘各國暫時沒有容易取得的官方資料，用的是 Natural Earth 的一級行政區，這份資料放大之後比官方的粗，香港那一份就差了三十倍，而且不是每一國都跟上現況：印尼 2022 年巴布亞拆出新省，這裡仍是舊的 33 省。
