...
開場載起來的是地球本身、海岸線、海底地形、Tor 中繼與連線受阻，另外十層擺在左側面板最上方那一排格子裡。按一下才去抓那一份資料並畫上去，再按一下收回去，沒按過的層完全不佔流量。

十四份資料壓縮後合計 800 KB，開場那五層佔 666 KB，其餘十層合起來 134 KB。省下來的不算多，因為地球本身的國界與海岸線就佔了全部的六成，那兩份必須先到。真正的差別在台灣那五層，它們佔了按需那部分的七成，而多數讀者不會放大到看得見變電所的距離。
