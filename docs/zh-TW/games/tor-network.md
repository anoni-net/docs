...
海面上較細的線條是海底電纜，取自 OpenStreetMap 貢獻者標註的兩百餘段路徑，收錄以歐洲、地中海與大西洋較為完整。最淡的一層是主要跨洋走廊的示意，取兩端公開的登陸地點拉出大圓弧，僅走向可信，實際路由請參考專門的海纜地圖。國界與海岸線來自 Natural Earth 的 10m 比例尺。東亞那一塊涵蓋中國東南沿海、台灣、日本、韓國、菲律賓、中南半島、馬來半島與蘇門答臘，海岸線簡化時留到約 220 公尺，相鄰兩點相距 2.3 公里，國界留到約 330 公尺，相鄰兩點相距 2.8 公里。兩層要在同一個量級，其中一層粗太多的話，放大之後會看到平滑的海岸線旁邊擺著一條階梯狀的國界。其餘亞洲與世界其他地方逐級放粗，因為站上的讀者多半在東亞。歐洲與美洲那幾級的點距是數十公里，島嶼只是幾個點連成的折線，放大之後看起來是一段一段的方塊。陸地的填色走另一條路，先畫成貼圖再貼上球面。全球那張是 2048x1024，赤道一個像素就是 19.6 公里，香港在上面只有 3 個像素，填色糊成一團而且邊緣跟海岸線差了十幾公里。東亞另外畫一張 2048 見方的，一個像素降到 2.8 公里，香港變成 147 個像素。澳門 33 平方公里在那張上面仍然只有 4 個像素，形狀要靠向量的國界線讀。
