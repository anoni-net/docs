...
海面上較細的線條是海底電纜，取自 OpenStreetMap 貢獻者標註的兩百餘段路徑，收錄以歐洲、地中海與大西洋較為完整。最淡的一層是主要跨洋走廊的示意，取兩端公開的登陸地點拉出大圓弧，僅走向可信，實際路由請參考專門的海纜地圖。國界與海岸線來自 Natural Earth 的 10m 比例尺。東亞那一塊的海岸線簡化時留到約 220 公尺，相鄰兩點相距 2.2 公里，其餘亞洲與世界其他地方逐級放粗，因為站上的讀者多半在東亞。更粗的比例尺下，日本與菲律賓的島鏈只是幾個點連成的折線，放大之後看起來是一段一段的方塊。
